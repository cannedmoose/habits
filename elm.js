...
{
	if (region.aC.am === region.aO.am)
	{
		return 'on line ' + region.aC.am;
	}
	return 'on lines ' + region.aC.am + ' through ' + region.aO.am;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aS: fragment, aV: host, a1: path, a4: port_, a9: protocol, ba: query};
	});
...
var $author$project$HabitStore$emptyHabit = function (id) {
	return {
		aw: $author$project$Habit$Unblocked,
		bx: '',
		by: 0,
		bD: id,
		bJ: $elm$core$Maybe$Nothing,
		a$: $elm$time$Time$millisToPosix(0),
		bS: A2($author$project$Period$fromString, 1, 'Day'),
		bZ: ''
	};
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aI: s.aI + (newOffset - s.b), f: s.f, h: s.h, b: newOffset, be: s.be, a: s.a};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aI: col, bw: contextStack, a5: problem, be: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.be, s.aI, x, s.f));
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.be, s.aI - (floatOffset + s.b), invalid, s.f));
		} else {
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.be, s.aI, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aI: newCol, f: s.f, h: s.h, b: newOffset, be: newRow, a: s.a});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aI: col, f: s0.f, h: s0.h, b: offset, be: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.be, s.aI, s);
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aI: col, a5: problem, be: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.be, p.aI, p.a5);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aI: 1, f: _List_Nil, h: 1, b: 0, be: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$init = function (flags) {
	...
	var storage = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$storageDecoder, flags.az);
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {aA: oldTime, bc: request, bk: subs};
	});
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {a7: processes, bl: taggers};
	});
...
var $elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _v0 = A2($elm$core$Dict$get, interval, state.bl);
		if (_v0.$ === 1) {
...
var $mdgriffith$elm_style_animation$Animation$initMotion = F2(
	function (position, unit) {
		return {
			Z: $mdgriffith$elm_style_animation$Animation$Model$Spring(
				{aK: 26, bi: 170}),
...
var $mdgriffith$elm_style_animation$Animation$easing = function (_v0) {
	...
	return $mdgriffith$elm_style_animation$Animation$Model$Easing(
		{
			aM: $elm$time$Time$millisToPosix(
...
var $author$project$Main$slideEase2 = $mdgriffith$elm_style_animation$Animation$easing(
	{aM: 700, aN: $elm_community$easing_functions$Ease$inOutCubic});
...
var $mdgriffith$elm_style_animation$Animation$defaultInterpolationByProperty = function (prop) {
	var linear = function (duration) {
		return $mdgriffith$elm_style_animation$Animation$Model$Easing(
			{aM: duration, aN: $elm$core$Basics$identity, a8: 1, aC: 0});
	};
	...
	switch (prop.$) {
		...
		case 5:
			...
			return (name === 'rotate3d') ? $mdgriffith$elm_style_animation$Animation$speed(
				{a2: $elm$core$Basics$pi}) : defaultSpring;
		case 6:
			return defaultSpring;
		case 7:
			return $mdgriffith$elm_style_animation$Animation$speed(
				{a2: $elm$core$Basics$pi});
		case 8:
			return defaultSpring;
		default:
			return defaultSpring;
...
var $author$project$Main$slideEase = $mdgriffith$elm_style_animation$Animation$easing(
	{aM: 400, aN: $elm_community$easing_functions$Ease$inOutCubic});
			...
			return _Utils_update(
				model,
				{
					...
					N: $elm$core$Maybe$Just(
						{W: 0, c: habits, d: options, e: screen, g: time})
				});
		}
	});
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$NextDueChange(habit.a$)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					...
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$BlockChange(habit.aw)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$PeriodChange(habit.bS))
				]),
			function () {
				var _v0 = habit.bJ;
				if (!_v0.$) {
	...
	function (store, time, habit) {
		var blockedHabits = $elm$core$Dict$toList(
			A2(
				...
				F2(
					function (_v1, h) {
						return A2($author$project$Habit$isBlocker, habit.bD, h) && $author$project$Habit$isBlocked(h);
					}),
				store));
		return _Utils_ap(
			_List_fromArray(
				[
					...
					habit.bD,
					$author$project$HabitStore$NextDueChange(
						A2($author$project$Period$addToPosix, habit.bS, time))),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.bD,
					...
					habit.bD,
					$author$project$HabitStore$BlockChange(
						$author$project$Habit$doBlock(habit.aw)))
				]),
			A2(
				...
				function (_v0) {
					...
					return _List_fromArray(
						[
							...
							hid,
							$author$project$HabitStore$BlockChange(
								A2($author$project$Habit$Blocker, habit.bD, false))),
							A2(
							$author$project$HabitStore$ChangeHabit,
							hid,
							$author$project$HabitStore$NextDueChange(
								A2($author$project$Period$addToPosix, h.bS, time)))
						]);
				},
				blockedHabits));
	});
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'period',
					$author$project$Period$toString(habit.bS))
				]),
			blocker));
};
		...
		if (_v1.$ === 1) {
			...
			return _Utils_update(
				model,
				{
					...
					e: newScreen,
					N: $elm$core$Maybe$Just(
						{W: 1, c: habits, d: options, e: screen, g: time})
				});
		}
	});
...
var $author$project$Habit$isDue = F2(
	function (time, habit) {
		return _Utils_cmp(
			$elm$time$Time$posixToMillis(habit.a$),
...
var $author$project$Main$shouldBeMarkedAsDone = F2(
	function (model, habit) {
		return $author$project$Habit$isBlocked(habit) ? true : ((_Utils_cmp(
			$author$project$Period$toMillis(habit.bS),
...
var $author$project$Main$habitOrderer = F2(
	function (model, habit) {
		return A2($author$project$Main$shouldBeMarkedAsDone, model, habit) ? $elm$time$Time$posixToMillis(
			A2($elm$core$Maybe$withDefault, model.g, habit.bJ)) : ((-1) * ($elm$time$Time$posixToMillis(habit.a$) - $elm$time$Time$posixToMillis(model.g)));
	});
...
var $mdgriffith$elm_style_animation$Animation$Model$refreshTiming = F2(
	function (now, timing) {
		var dt = $elm$time$Time$posixToMillis(now) - $elm$time$Time$posixToMillis(timing.aJ);
		return {
			aJ: now,
			bA: ((dt > 34) || (!$elm$time$Time$posixToMillis(timing.aJ))) ? $elm$time$Time$millisToPosix(
...
var $mdgriffith$elm_style_animation$Animation$Model$isCmdDone = function (cmd) {
	var motionDone = function (motion) {
		return (!motion.b1) && _Utils_eq(motion.bT, motion.b_);
	};
	switch (cmd.$) {
		case 0:
			var m1 = cmd.a;
		...
		case 16:
			var arc = cmd.a;
			return motionDone(arc.bp) && (motionDone(arc.bq) && (motionDone(arc.an) && (motionDone(arc.ao) && motionDone(arc.ak))));
		case 17:
			var arc = cmd.a;
			return motionDone(arc.bp) && (motionDone(arc.bq) && (motionDone(arc.an) && (motionDone(arc.ao) && motionDone(arc.ak))));
		default:
...
var $mdgriffith$elm_style_animation$Animation$Model$isDone = function (property) {
	var motionDone = function (motion) {
		var runningInterpolation = A2($elm$core$Maybe$withDefault, motion.Z, motion.bH);
		switch (runningInterpolation.$) {
			case 0:
				return (!motion.b1) && _Utils_eq(motion.bT, motion.b_);
			case 1:
				var eased = runningInterpolation.a;
				return (eased.a8 === 1) || ((!eased.a8) && _Utils_eq(motion.bT, motion.b_));
			default:
				var speed = runningInterpolation.a;
				return _Utils_eq(motion.bT, motion.b_);
		}
	};
	switch (property.$) {
		case 0:
			...
			function (motion, targetMotion) {
				...
				if (_v27.$ === 1) {
					...
					return _Utils_update(
						motion,
						{
							Z: $mdgriffith$elm_style_animation$Animation$Model$Easing(
								_Utils_update(
									ease,
									{aC: motion.bT})),
							b_: targetMotion.bT
						...
						function () {
							...
							return _Utils_update(
								arc,
								{
									...
									bp: A2(setMotionTarget, x, target.bp),
									bq: A2(setMotionTarget, y, target.bq)
								});
						}());
				} else {
					return cmd;
		...
		var setMotionTarget = F2(
			function (motion, targetMotion) {
				var newMotion = overrideInterpolation ? _Utils_update(
					motion,
					{
						bH: $elm$core$Maybe$Just(targetMotion.Z)
					}) : motion;
				var _v13 = newMotion.bH;
				if (_v13.$ === 1) {
					var _v14 = newMotion.Z;
					if (_v14.$ === 1) {
						var ease = _v14.a;
						return _Utils_update(
							newMotion,
...
var $mdgriffith$elm_style_animation$Animation$Model$stepInterpolation = F2(
	function (posix, motion) {
		var interpolationToUse = A2($elm$core$Maybe$withDefault, motion.Z, motion.bH);
		var dtms = $elm$time$Time$posixToMillis(posix);
		switch (interpolationToUse.$) {
			case 2:
				var perSecond = interpolationToUse.a.a2;
				var _v1 = function () {
					if (_Utils_cmp(motion.bT, motion.b_) < 0) {
						var _new = motion.bT + (perSecond * (dtms / 1000));
						return _Utils_Tuple2(
							_new,
				...
				return finished ? _Utils_update(
					motion,
					{bT: motion.b_, b1: 0.0}) : _Utils_update(
					motion,
					{bT: newPos, b1: perSecond * 1000});
			case 0:
				var stiffness = interpolationToUse.a.bi;
				var damping = interpolationToUse.a.aK;
				var fspring = stiffness * (motion.b_ - motion.bT);
				var fdamper = ((-1) * damping) * motion.b1;
				var dt = dtms / 1000;
				var a = fspring + fdamper;
				var newVelocity = motion.b1 + (a * dt);
				var newPos = motion.bT + (newVelocity * dt);
				...
				return ((_Utils_cmp(dx, $mdgriffith$elm_style_animation$Animation$Model$tolerance) < 0) && (_Utils_cmp(
					...
					{bT: motion.b_, b1: 0.0}) : _Utils_update(
					motion,
					{bT: newPos, b1: newVelocity});
			default:
				var progress = interpolationToUse.a.a8;
				var duration = interpolationToUse.a.aM;
				var ease = interpolationToUse.a.aN;
				var start = interpolationToUse.a.aC;
				...
				var newVelocity = (newProgress === 1) ? 0 : ((newPos - motion.bT) / dtms);
				var _v2 = motion.bH;
				if (_v2.$ === 1) {
					return _Utils_update(
						motion,
						{
							Z: $mdgriffith$elm_style_animation$Animation$Model$Easing(
								{aM: duration, aN: ease, a8: newProgress, aC: start}),
							bT: newPos,
							b1: newVelocity
						});
				} else {
...
var $mdgriffith$elm_style_animation$Animation$Model$updateAnimation = F2(
	function (_v0, _v1) {
		var now = _v0;
		var model = _v1;
		var timing = A2($mdgriffith$elm_style_animation$Animation$Model$refreshTiming, now, model.bm);
		var _v2 = A2(
			$elm$core$List$partition,
			function (_v4) {
				var wait = _v4.a;
		...
		var _v5 = function () {
			...
			if (!_v6.$) {
				...
				return _Utils_Tuple2(model.aD, model.bj);
			}
		}();
		var steps = _v5.a;
		var style = _v5.b;
					...
					return _Utils_Tuple2(
						A2(
							...
							$author$project$Main$SelectHabit(
								{at: forHabit, u: 0, m: model.e, av: selected}),
							model),
						$elm$core$Platform$Cmd$none);
				case 11:
					var _v9 = _v0.b;
				...
				case 7:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							...
							model.c,
							A3($author$project$HabitStore$deleteHabitDeltas, model.c, model.g, screen.al));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
				...
				case 8:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							$author$project$HabitStore$applyDeltas,
							model.c,
							A4($author$project$HabitStore$editHabitDeltas, model.c, model.g, screen.al, screen.r));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
		...
		return A2(
			...
			A2(
				...
				function (_v11) {
					var x = _v11.a;
					var y = _v11.b;
					return $elm$core$String$fromFloat(x.bT) + (',' + $elm$core$String$fromFloat(y.bT));
				},
				coords));
	};
	switch (cmd.$) {
		case 0:
			var x = cmd.a;
			var y = cmd.b;
			return 'm ' + ($elm$core$String$fromFloat(x.bT) + (',' + $elm$core$String$fromFloat(y.bT)));
		case 1:
			var x = cmd.a;
			var y = cmd.b;
			return 'M ' + ($elm$core$String$fromFloat(x.bT) + (',' + $elm$core$String$fromFloat(y.bT)));
		case 2:
			var x = cmd.a;
			var y = cmd.b;
			return 'l ' + ($elm$core$String$fromFloat(x.bT) + (',' + $elm$core$String$fromFloat(y.bT)));
		case 3:
			var x = cmd.a;
			var y = cmd.b;
			return 'L ' + ($elm$core$String$fromFloat(x.bT) + (',' + $elm$core$String$fromFloat(y.bT)));
		case 4:
			var a = cmd.a;
			return 'h ' + $elm$core$String$fromFloat(a.bT);
		case 5:
			var a = cmd.a;
			return 'H ' + $elm$core$String$fromFloat(a.bT);
		case 6:
			var a = cmd.a;
			return 'v ' + $elm$core$String$fromFloat(a.bT);
		case 7:
			var a = cmd.a;
			return 'V ' + $elm$core$String$fromFloat(a.bT);
		case 8:
			...
			var c1x = _v3.a;
			var c1y = _v3.b;
			return 'c ' + ($elm$core$String$fromFloat(c1x.bT) + (' ' + ($elm$core$String$fromFloat(c1y.bT) + (', ' + ($elm$core$String$fromFloat(c2x.bT) + (' ' + ($elm$core$String$fromFloat(c2y.bT) + (', ' + ($elm$core$String$fromFloat(p1x.bT) + (' ' + $elm$core$String$fromFloat(p1y.bT)))))))))));
		case 9:
			var control1 = cmd.a.ah;
			var control2 = cmd.a.ai;
			var point = cmd.a.L;
		...
		case 10:
			...
			var c1x = _v8.a;
			var c1y = _v8.b;
			return 'q ' + ($elm$core$String$fromFloat(c1x.bT) + (' ' + ($elm$core$String$fromFloat(c1y.bT) + (', ' + ($elm$core$String$fromFloat(p1x.bT) + (' ' + $elm$core$String$fromFloat(p1y.bT)))))));
		case 11:
			var control = cmd.a.ag;
			var point = cmd.a.L;
			var _v9 = point;
		...
		case 16:
			var arc = cmd.a;
			var deltaAngle = arc.ak.bT - arc.ao.bT;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				var dy = arc.an.bT * $elm$core$Basics$sin(
					$elm$core$Basics$degrees(arc.ao.bT));
				var dx = arc.an.bT * $elm$core$Basics$cos(
					$elm$core$Basics$degrees(arc.ao.bT));
				return 'A ' + ($elm$core$String$fromFloat(arc.an.bT) + (',' + ($elm$core$String$fromFloat(arc.an.bT) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bp.bT - dx) + (',' + ($elm$core$String$fromFloat(arc.bq.bT - dy) + (' A ' + ($elm$core$String$fromFloat(arc.an.bT) + (',' + ($elm$core$String$fromFloat(arc.an.bT) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bp.bT + dx) + (',' + $elm$core$String$fromFloat(arc.bq.bT + dy)))))))))))))));
			} else {
				return 'A ' + ($elm$core$String$fromFloat(arc.an.bT) + (',' + ($elm$core$String$fromFloat(arc.an.bT) + (' 0 ' + (((deltaAngle >= 180) ? '1' : '0') + (' ' + ('1' + (' ' + ($elm$core$String$fromFloat(
					arc.bp.bT + (arc.an.bT * $elm$core$Basics$cos(
						$elm$core$Basics$degrees(arc.ak.bT)))) + (',' + $elm$core$String$fromFloat(
					arc.bq.bT + (arc.an.bT * $elm$core$Basics$sin(
						$elm$core$Basics$degrees(arc.ak.bT))))))))))))));
			}
		case 17:
			var arc = cmd.a;
			var deltaAngle = arc.ak.bT - arc.ao.bT;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				...
				var dx = arc.an.bT * $elm$core$Basics$cos(
					$elm$core$Basics$degrees(arc.ao.bT));
				return 'A ' + ($elm$core$String$fromFloat(arc.an.bT) + (',' + ($elm$core$String$fromFloat(arc.an.bT) + (',0,1,0,' + ($elm$core$String$fromFloat(arc.bp.bT - dx) + (',' + ($elm$core$String$fromFloat(arc.bq.bT - dy) + (' A ' + ($elm$core$String$fromFloat(arc.an.bT) + (',' + ($elm$core$String$fromFloat(arc.an.bT) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bp.bT + dx) + (',' + $elm$core$String$fromFloat(arc.bq.bT + dy)))))))))))))));
			} else {
				return 'A ' + ($elm$core$String$fromFloat(arc.an.bT) + (',' + ($elm$core$String$fromFloat(arc.an.bT) + (' 0 ' + ((((arc.ao.bT - arc.ak.bT) >= 180) ? '1' : '0') + (' ' + ('0' + (' ' + ($elm$core$String$fromFloat(
					arc.bp.bT + (arc.an.bT * $elm$core$Basics$cos(arc.ak.bT))) + (',' + $elm$core$String$fromFloat(
					arc.bq.bT + (arc.an.bT * $elm$core$Basics$sin(arc.ak.bT)))))))))))));
			}
		default:
			return 'z';
	}
		...
		switch (prop.$) {
			...
			case 1:
				...
				return 'rgba(' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(r.bT)) + (',' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(g.bT)) + (',' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(b.bT)) + (',' + ($elm$core$String$fromFloat(a.bT) + ')')))))));
			case 2:
				var name = prop.a;
				var inset = prop.b;
				var shadow = prop.c;
				return (inset ? 'inset ' : '') + ($elm$core$String$fromFloat(shadow.H.bT) + ('px' + (' ' + ($elm$core$String$fromFloat(shadow.I.bT) + ('px' + (' ' + ($elm$core$String$fromFloat(shadow.F.bT) + ('px' + (' ' + ((((name === 'text-shadow') || (name === 'drop-shadow')) ? '' : ($elm$core$String$fromFloat(shadow.M.bT) + ('px' + ' '))) + ('rgba(' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.C.bT)) + (', ' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.A.bT)) + (', ' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.x.bT)) + (', ' + ($elm$core$String$fromFloat(shadow.w.bT) + ')'))))))))))))))))));
			case 3:
				var x = prop.b;
				return _Utils_ap(
					$elm$core$String$fromFloat(x.bT),
					x.b$);
			case 4:
				var x = prop.b;
				var y = prop.c;
				return _Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							delim,
							_Utils_ap(
								$elm$core$String$fromFloat(y.bT),
								y.b$))));
			case 5:
				var x = prop.b;
				var y = prop.c;
							...
							_Utils_ap(
								...
								_Utils_ap(
									...
									_Utils_ap(
										delim,
										_Utils_ap(
											$elm$core$String$fromFloat(z.bT),
											z.b$)))))));
			case 6:
				var w = prop.b;
				var x = prop.c;
				...
				var z = prop.e;
				return _Utils_ap(
					$elm$core$String$fromFloat(w.bT),
					_Utils_ap(
						w.b$,
						_Utils_ap(
							delim,
...
var $mdgriffith$elm_style_animation$Animation$Render$render3dRotation = function (prop) {
	if (prop.$ === 5) {
		...
		var y = prop.c;
		var z = prop.d;
		return 'rotateX(' + ($elm$core$String$fromFloat(x.bT) + (x.b$ + (') rotateY(' + ($elm$core$String$fromFloat(y.bT) + (y.b$ + (') rotateZ(' + ($elm$core$String$fromFloat(z.bT) + (z.b$ + ')'))))))));
	} else {
		return '';
	}
};
var $mdgriffith$elm_style_animation$Animation$Render$renderValues = function (_v0) {
	var model = _v0;
	var _v1 = A2($elm$core$List$partition, $mdgriffith$elm_style_animation$Animation$Render$isAttr, model.bj);
	var attrProps = _v1.a;
...
var $author$project$Page$viewPage = F3(
	function (config, state, lines) {
		...
		var nEmptyLines = config._ - $elm$core$List$length(culledLines);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
								...
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('add-habit'),
											$elm$html$Html$Events$onClick(
											config.aa($author$project$Page$OpenOptions))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('-')
		...
		var pageConfig = {
			Y: _Utils_Tuple2(
				A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id('editForm')
						]),
					_List_Nil),
				A2(
					$elm$html$Html$div,
			...
			_: $author$project$Main$pageLines,
			aa: $author$project$Main$PageAction,
			ac: false,
			U: 'edit \"' + (title + '\"')
		};
...
var $author$project$Main$viewEmptyPage = function (_v0) {
	var pageConfig = {
		Y: _Utils_Tuple2($author$project$Main$emptyDiv, $author$project$Main$emptyDiv),
		_: $author$project$Main$pageLines,
		aa: $author$project$Main$PageAction,
		ac: false,
		U: ''
...
var $author$project$Main$viewHabitsListPage = F2(
	function (model, habitListScreen) {
		var pageState = {ab: habitListScreen.u};
		var pageConfig = {
			Y: _Utils_Tuple2(
				A2(
					$elm$html$Html$button,
