...
{
	if (region.aF.ak === region.aS.ak)
	{
		return 'on line ' + region.aF.ak;
	}
	return 'on lines ' + region.aF.ak + ' through ' + region.aS.ak;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bF: 'hidden', by: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bF: 'mozHidden', by: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bF: 'msHidden', by: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bF: 'webkitHidden', by: 'webkitvisibilitychange' }
		: { bF: 'hidden', by: 'visibilitychange' };
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{p: nodeList, i: (len / $elm$core$Array$branchFactor) | 0, l: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aW: fragment, aZ: host, a4: path, a7: port_, bc: protocol, bd: query};
	});
...
var $author$project$Main$NoScreen = {$: 5};
...
var $author$project$Habit$Unblocked = {$: 1};
...
var $author$project$HabitStore$emptyHabit = function (id) {
	return {
		ay: $author$project$Habit$Unblocked,
		bA: '',
		bB: 0,
		bG: id,
		bM: $elm$core$Maybe$Nothing,
		bQ: $elm$time$Time$millisToPosix(0),
		bV: A2($author$project$Period$fromString, 1, 'Day'),
		b_: ''
	};
};
...
var $author$project$Main$StorageModel = F3(
	function (options, habits, version) {
		return {e: habits, g: options, b3: version};
	});
var $author$project$Main$defaultOptions = {
	x: $author$project$Period$Hours(12),
	k: _List_Nil,
	u: $author$project$Period$Hours(12)
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aM: s.aM + (newOffset - s.c), d: s.d, f: s.f, c: newOffset, bh: s.bh, a: s.a};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aM: col, bz: contextStack, a8: problem, bh: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bh, s.aM, x, s.d));
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bh, s.aM - (floatOffset + s.c), invalid, s.d));
		} else {
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.c, s.bh, s.aM, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aM: newCol, d: s.d, f: s.f, c: newOffset, bh: newRow, a: s.a});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aM: col, d: s0.d, f: s0.f, c: offset, bh: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.c, s.bh, s.aM, s);
	};
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aM: 1, d: _List_Nil, f: 1, c: 0, bh: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$Options = F3(
	function (recent, upcoming, seenModals) {
		return {x: recent, k: seenModals, u: upcoming};
	});
...
var $author$project$Main$init = function (flags) {
	var time = $elm$time$Time$millisToPosix(flags.m);
	var storage = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$storageDecoder, flags.aB);
	...
	return _Utils_Tuple2(
		{
			...
			e: A2($author$project$HabitStore$applyDeltas, $elm$core$Dict$empty, storage2.e),
			z: 0,
			g: storage2.g,
			G: $elm$core$Maybe$Nothing,
			b: $author$project$Main$NoScreen,
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {aC: oldTime, bf: request, bn: subs};
	});
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {ba: processes, bo: taggers};
	});
...
var $mdgriffith$elm_style_animation$Animation$initMotion = F2(
	function (position, unit) {
		return {
			V: $mdgriffith$elm_style_animation$Animation$Model$Spring(
				{aO: 26, bl: 170}),
...
var $mdgriffith$elm_style_animation$Animation$easing = function (_v0) {
	...
	return $mdgriffith$elm_style_animation$Animation$Model$Easing(
		{
			aQ: $elm$time$Time$millisToPosix(
...
var $author$project$Main$slideEase2 = $mdgriffith$elm_style_animation$Animation$easing(
	{aQ: 700, aR: $elm_community$easing_functions$Ease$inOutCubic});
var $mdgriffith$elm_style_animation$Animation$initialState = function (current) {
	return {
		...
		bp: {
			...
			bD: $elm$time$Time$millisToPosix(0)
		}
	};
};
...
var $mdgriffith$elm_style_animation$Animation$defaultInterpolationByProperty = function (prop) {
	var linear = function (duration) {
		return $mdgriffith$elm_style_animation$Animation$Model$Easing(
			{aQ: duration, aR: $elm$core$Basics$identity, bb: 1, aF: 0});
	};
	...
	switch (prop.$) {
		...
		case 5:
			...
			return (name === 'rotate3d') ? $mdgriffith$elm_style_animation$Animation$speed(
				{a5: $elm$core$Basics$pi}) : defaultSpring;
		case 6:
			return defaultSpring;
		case 7:
			return $mdgriffith$elm_style_animation$Animation$speed(
				{a5: $elm$core$Basics$pi});
		case 8:
			return defaultSpring;
		default:
			return defaultSpring;
		...
		switch (cmd.$) {
			...
			case 7:
				...
				return $mdgriffith$elm_style_animation$Animation$Model$VerticalTo(
					fn(motion));
			case 8:
				var control1 = cmd.a.ae;
				var control2 = cmd.a.af;
				var point = cmd.a.H;
	...
	function (fn, prop) {
		switch (prop.$) {
			...
			case 2:
				...
				var size = shadow.I;
				var red = shadow.av;
				var offsetY = shadow.E;
				var offsetX = shadow.D;
				var green = shadow.au;
				var blur = shadow.B;
				var blue = shadow.as;
				var alpha = shadow.ar;
...
var $author$project$Main$afterDoHabitModalUpdate = function (model) {
	var options = model.g;
	return (!A2($elm$core$List$member, 5, options.k)) ? $author$project$Main$modalInTransition(
		_Utils_update(
			model,
			{
				z: 5,
				g: _Utils_update(
					options,
					{
						k: A2($elm$core$List$cons, 5, options.k)
					})
			})) : model;
};
...
var $author$project$Main$slideEase = $mdgriffith$elm_style_animation$Animation$easing(
	{aQ: 400, aR: $elm_community$easing_functions$Ease$inOutCubic});
...
var $author$project$Main$afterModalModelUpdate = F2(
	function (modal, model) {
		var _v0 = _Utils_Tuple2(model.b, modal);
		if ((_v0.a.$ === 5) && (_v0.b === 1)) {
			var _v1 = _v0.a;
			var _v2 = _v0.b;
			return A2(
				...
				_Utils_update(
					model,
					{
						b: $author$project$Main$HabitList(
							{A: 0})
					}));
		} else {
			return model;
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$DescriptionChange(habit.bA)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					...
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$NextDueChange(habit.bQ)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$DoneCountChange(habit.bB)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$BlockChange(habit.ay)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$PeriodChange(habit.bV))
				]),
			function () {
				var _v0 = habit.bM;
				if (!_v0.$) {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'recent',
				$author$project$Period$encode(options.x)),
				_Utils_Tuple2(
				'upcoming',
				$author$project$Period$encode(options.u)),
				_Utils_Tuple2(
				'seenModals',
				A2($elm$json$Json$Encode$list, $author$project$Main$modalEncoder, options.k))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'options',
				$author$project$Main$optionsEncoder(model.g)),
				_Utils_Tuple2(
				'habits',
				A2(
					$elm$json$Json$Encode$list,
					$author$project$HabitStore$encode,
					A2($author$project$HabitStore$deltasFromDict, model.m, model.e))),
				_Utils_Tuple2(
				'version',
				$elm$json$Json$Encode$int(0))
			]));
...
var $author$project$Main$afterTransitionModalUpdate = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return (!A2($elm$core$List$member, 2, options.k)) ? $author$project$Main$storeModel(
				_Utils_Tuple2(
						...
						_Utils_update(
							model,
							{
								...
								g: _Utils_update(
									options,
									{
										k: A2($elm$core$List$cons, 2, options.k)
									})
							})),
					cmd)) : (((!A2($elm$core$List$member, 4, options.k)) && (!$elm$core$Dict$isEmpty(model.e))) ? $author$project$Main$storeModel(
				_Utils_Tuple2(
					$author$project$Main$modalInTransition(
						_Utils_update(
							model,
							{
								...
								g: _Utils_update(
									options,
									{
										k: A2($elm$core$List$cons, 4, options.k)
									})
							})),
					cmd)) : _Utils_Tuple2(model, cmd));
		case 2:
			return (!A2($elm$core$List$member, 3, options.k)) ? $author$project$Main$storeModel(
				_Utils_Tuple2(
					$author$project$Main$modalInTransition(
						_Utils_update(
							model,
							{
								...
								g: _Utils_update(
									options,
									{
										k: A2($elm$core$List$cons, 3, options.k)
									})
							})),
					cmd)) : _Utils_Tuple2(model, cmd);
		default:
...
var $author$project$Habit$doBlock = function (block) {
	if (!block.$) {
		var otherId = block.a;
	...
	function (store, time, habit) {
		var blockedHabits = $elm$core$Dict$toList(
			A2(
				...
				F2(
					function (_v1, h) {
						return A2($author$project$Habit$isBlocker, habit.bG, h) && $author$project$Habit$isBlocked(h);
					}),
				store));
		return _Utils_ap(
			_List_fromArray(
				[
					A2($author$project$HabitStore$Group, time, 'do ' + habit.bG),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.bG,
					...
					habit.bG,
					$author$project$HabitStore$NextDueChange(
						A2($author$project$Period$addToPosix, habit.bV, time))),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.bG,
					$author$project$HabitStore$DoneCountChange(habit.bB + 1)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.bG,
					$author$project$HabitStore$BlockChange(
						$author$project$Habit$doBlock(habit.ay)))
				]),
			A2(
				...
				function (_v0) {
					...
					return _List_fromArray(
						[
							...
							hid,
							$author$project$HabitStore$BlockChange(
								A2($author$project$Habit$Blocker, habit.bG, false))),
							A2(
							$author$project$HabitStore$ChangeHabit,
							hid,
							$author$project$HabitStore$NextDueChange(
								A2($author$project$Period$addToPosix, h.bV, time)))
						]);
				},
				blockedHabits));
	});
...
var $author$project$Main$habitToFields = function (habit) {
	...
	return $elm$core$Dict$fromList(
		_Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2('description', habit.bA),
					_Utils_Tuple2('tag', habit.b_),
					_Utils_Tuple2(
					'period',
					$author$project$Period$toString(habit.bV))
				]),
			blocker));
};
		...
		return A2(
			...
			function (habit) {
				return $author$project$Main$EditHabit(
					{
						r: _List_Nil,
						o: $author$project$Main$habitToFields(habit),
						aj: habitId,
						q: model.b
					});
			},
			A2($elm$core$Dict$get, habitId, model.e));
	});
...
var $mdgriffith$elm_style_animation$Animation$Model$refreshTiming = F2(
	function (now, timing) {
		var dt = $elm$time$Time$posixToMillis(now) - $elm$time$Time$posixToMillis(timing.aN);
		return {
			aN: now,
			bD: ((dt > 34) || (!$elm$time$Time$posixToMillis(timing.aN))) ? $elm$time$Time$millisToPosix(
...
var $mdgriffith$elm_style_animation$Animation$Model$isCmdDone = function (cmd) {
	var motionDone = function (motion) {
		return (!motion.b2) && _Utils_eq(motion.bW, motion.b$);
	};
	switch (cmd.$) {
		case 0:
			var m1 = cmd.a;
		...
		case 16:
			var arc = cmd.a;
			return motionDone(arc.bs) && (motionDone(arc.bt) && (motionDone(arc.al) && (motionDone(arc.am) && motionDone(arc.ai))));
		case 17:
			var arc = cmd.a;
			return motionDone(arc.bs) && (motionDone(arc.bt) && (motionDone(arc.al) && (motionDone(arc.am) && motionDone(arc.ai))));
		default:
...
var $mdgriffith$elm_style_animation$Animation$Model$isDone = function (property) {
	var motionDone = function (motion) {
		var runningInterpolation = A2($elm$core$Maybe$withDefault, motion.V, motion.bK);
		switch (runningInterpolation.$) {
			case 0:
				return (!motion.b2) && _Utils_eq(motion.bW, motion.b$);
			case 1:
				var eased = runningInterpolation.a;
				return (eased.bb === 1) || ((!eased.bb) && _Utils_eq(motion.bW, motion.b$));
			default:
				var speed = runningInterpolation.a;
				return _Utils_eq(motion.bW, motion.b$);
		}
	};
	switch (property.$) {
		case 0:
		...
		case 2:
			...
			return A2(
				...
				motionDone,
				_List_fromArray(
					[shadow.D, shadow.E, shadow.I, shadow.B, shadow.av, shadow.au, shadow.as, shadow.ar]));
		case 3:
			var m1 = property.b;
			...
			function (motion, targetMotion) {
				...
				if (_v27.$ === 1) {
					...
					return _Utils_update(
						motion,
						{
							V: $mdgriffith$elm_style_animation$Animation$Model$Easing(
								_Utils_update(
									ease,
									{aF: motion.bW})),
							b$: targetMotion.bW
			...
			case 8:
				...
				if (targetCmd.$ === 8) {
					...
					return $mdgriffith$elm_style_animation$Animation$Model$Curve(
						{
							ae: _Utils_Tuple2(
								A2(setMotionTarget, points.ae.a, targets.ae.a),
								A2(setMotionTarget, points.ae.b, targets.ae.b)),
							af: _Utils_Tuple2(
								A2(setMotionTarget, points.af.a, targets.af.a),
								A2(setMotionTarget, points.af.b, targets.af.b)),
							H: _Utils_Tuple2(
								A2(setMotionTarget, points.H.a, targets.H.a),
								A2(setMotionTarget, points.H.b, targets.H.b))
						});
				} else {
					return cmd;
				}
					...
					return $mdgriffith$elm_style_animation$Animation$Model$ClockwiseArc(
						function () {
							...
							return _Utils_update(
								arc,
								{
									ai: A2(setMotionTarget, endAngle, target.ai),
									al: A2(setMotionTarget, radius, target.al),
									am: A2(setMotionTarget, startAngle, target.am),
		...
		var setMotionTarget = F2(
			function (motion, targetMotion) {
				var newMotion = overrideInterpolation ? _Utils_update(
					motion,
					{
						bK: $elm$core$Maybe$Just(targetMotion.V)
					}) : motion;
				var _v13 = newMotion.bK;
				if (_v13.$ === 1) {
					var _v14 = newMotion.V;
					if (_v14.$ === 1) {
						var ease = _v14.a;
						return _Utils_update(
							newMotion,
...
var $mdgriffith$elm_style_animation$Animation$Model$stepInterpolation = F2(
	function (posix, motion) {
		var interpolationToUse = A2($elm$core$Maybe$withDefault, motion.V, motion.bK);
		var dtms = $elm$time$Time$posixToMillis(posix);
		switch (interpolationToUse.$) {
			case 2:
				var perSecond = interpolationToUse.a.a5;
				var _v1 = function () {
					if (_Utils_cmp(motion.bW, motion.b$) < 0) {
						var _new = motion.bW + (perSecond * (dtms / 1000));
						return _Utils_Tuple2(
							_new,
				...
				return finished ? _Utils_update(
					motion,
					{bW: motion.b$, b2: 0.0}) : _Utils_update(
					motion,
					{bW: newPos, b2: perSecond * 1000});
			case 0:
				var stiffness = interpolationToUse.a.bl;
				var damping = interpolationToUse.a.aO;
				var fspring = stiffness * (motion.b$ - motion.bW);
				var fdamper = ((-1) * damping) * motion.b2;
				var dt = dtms / 1000;
				var a = fspring + fdamper;
				var newVelocity = motion.b2 + (a * dt);
				var newPos = motion.bW + (newVelocity * dt);
				...
				return ((_Utils_cmp(dx, $mdgriffith$elm_style_animation$Animation$Model$tolerance) < 0) && (_Utils_cmp(
					...
					{bW: motion.b$, b2: 0.0}) : _Utils_update(
					motion,
					{bW: newPos, b2: newVelocity});
			default:
				var progress = interpolationToUse.a.bb;
				var duration = interpolationToUse.a.aQ;
				var ease = interpolationToUse.a.aR;
				var start = interpolationToUse.a.aF;
				...
				var newVelocity = (newProgress === 1) ? 0 : ((newPos - motion.bW) / dtms);
				var _v2 = motion.bK;
				if (_v2.$ === 1) {
					return _Utils_update(
						motion,
						{
							V: $mdgriffith$elm_style_animation$Animation$Model$Easing(
								{aQ: duration, aR: ease, bb: newProgress, aF: start}),
							bW: newPos,
							b2: newVelocity
						});
				} else {
				...
				return $mdgriffith$elm_style_animation$Animation$Model$ClockwiseArc(
					_Utils_update(
						arc,
						{
							...
							am: A2($mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.am),
			...
			switch (property.$) {
				...
				case 2:
					...
					return A3(
						...
						inset,
						{
							ar: A2($mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.ar),
							as: A2($mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.as),
							B: A2($mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.B),
							au: A2($mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.au),
							...
							av: A2($mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.av),
	...
	function (_v0, _v1) {
		...
		var _v2 = A2(
			...
			A2(
				...
				function (_v3) {
					...
					return _Utils_Tuple2(
						$elm$time$Time$millisToPosix(
							$elm$time$Time$posixToMillis(wait) - $elm$time$Time$posixToMillis(timing.bD)),
						mySteps);
				},
				model.az));
		...
		var _v5 = function () {
			...
			if (!_v6.$) {
				...
				return _Utils_Tuple2(model.aG, model.bm);
			}
		}();
		var steps = _v5.a;
		var style = _v5.b;
		var _v8 = A3($mdgriffith$elm_style_animation$Animation$Model$resolveSteps, style, steps, timing.bD);
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					...
					aw: (!(!$elm$core$List$length(revisedSteps))) || (!(!$elm$core$List$length(queuedInterruptions))),
					aG: revisedSteps,
					bm: revisedStyle,
					bp: timing
				}),
			...
			case 'description':
				return _Utils_update(
					page,
					{
						...
						o: A3($elm$core$Dict$insert, 'description', val, page.o)
					});
			case 'tag':
				return _Utils_update(
					page,
					{
						...
						o: A3($elm$core$Dict$insert, 'tag', val, page.o)
					});
			case 'period':
				return _Utils_update(
					page,
					{
						...
						o: A3($elm$core$Dict$insert, 'period', val, page.o)
					});
			default:
				return page;
		}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(model.b, msg);
		_v0$25:
		while (true) {
			switch (_v0.b.$) {
				case 0:
				...
				case 5:
					...
					var newStore = A2(
						...
						A2(
							$elm$core$Maybe$map,
							$author$project$HabitStore$applyDeltas(model.e),
							A2(
								$elm$core$Maybe$map,
								A2($author$project$HabitStore$doHabitDeltas, model.e, model.m),
								A2($elm$core$Dict$get, habitId, model.e))));
					...
					return _Utils_Tuple2(
						A2(
							...
							_Utils_update(
								model,
								{
									b: $author$project$Main$SelectHabit(
										{at: forHabit, A: 0, q: model.b, ax: selected})
								})),
						$elm$core$Platform$Cmd$none);
				case 11:
					var _v9 = _v0.b;
					return _Utils_Tuple2(
						A2(
							...
							_Utils_update(
								model,
								{
									b: $author$project$Main$CreateHabit(
										{
											r: _List_Nil,
											o: $author$project$Main$habitToFields(
				...
				case 17:
					if (!_v0.b.a.$) {
						if (_v0.a.$ === 5) {
							var _v11 = _v0.a;
							var el = _v0.b.a.a;
							var showModal = !A2($elm$core$List$member, 1, model.g.k);
							var options = model.g;
									...
									_Utils_update(
										model,
										{
											...
											g: _Utils_update(
												options,
												{
													k: A2($elm$core$List$cons, 1, options.k)
												}),
											G: $elm$core$Maybe$Just(el)
										})),
							...
							_Utils_update(
								model,
								{
									h: A2(
										...
										'modal-bg',
										A2($elm$core$Dict$remove, 'modal-fg', model.h)),
									z: 0
								})),
						$elm$core$Platform$Cmd$none);
				case 7:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							...
							model.e,
							A3($author$project$HabitStore$deleteHabitDeltas, model.e, model.m, screen.aj));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
				...
				case 8:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							$author$project$HabitStore$applyDeltas,
							model.e,
							A4($author$project$HabitStore$editHabitDeltas, model.e, model.m, screen.aj, screen.r));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
									$author$project$Main$flipOffRight,
							...
							if (!maybeHabitId.$) {
								...
								return _Utils_update(
									screen,
									{
										...
										o: A3($elm$core$Dict$insert, 'block', habitId, screen.o)
									});
							} else {
								return _Utils_update(
									screen,
									{
										r: A2(
											...
											screen.r,
											$author$project$HabitStore$BlockChange($author$project$Habit$Unblocked)),
										o: A2($elm$core$Dict$remove, 'block', screen.o)
									});
							}
						};
						return _Utils_Tuple2(
				...
				case 13:
					if (_v0.a.$ === 4) {
						...
						var updatedOptions = _Utils_update(
							options,
							{
								x: $author$project$Period$parse(screen.x),
								u: $author$project$Period$parse(screen.u)
							});
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
						...
						case 1:
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										b: $author$project$Main$EditHabit(
								...
								case 'recent':
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												b: $author$project$Main$EditOptions(
													_Utils_update(
														page,
														{x: val}))
											}),
					...
					if (_v0.b.a.$ === 1) {
								...
								_Utils_update(
									model,
									{
										b: $author$project$Main$EditOptions(
											{
												q: model.b,
												x: $author$project$Period$toString(model.g.x),
												u: $author$project$Period$toString(model.g.u)
											})
									})),
							$elm$core$Platform$Cmd$none);
					} else {
						switch (_v0.a.$) {
							case 0:
								...
								var page = _v0.b.a.a;
								return _Utils_Tuple2(
									((_Utils_cmp(page, screen.A) < 0) ? $author$project$Main$flipOffRight(model.b) : $author$project$Main$flipOn(model.b))(
										_Utils_update(
											model,
											{
												b: $author$project$Main$HabitList(
		...
		return A2(
			...
			A2(
				...
				function (_v11) {
					var x = _v11.a;
					var y = _v11.b;
					return $elm$core$String$fromFloat(x.bW) + (',' + $elm$core$String$fromFloat(y.bW));
				},
				coords));
	};
	switch (cmd.$) {
		case 0:
			var x = cmd.a;
			var y = cmd.b;
			return 'm ' + ($elm$core$String$fromFloat(x.bW) + (',' + $elm$core$String$fromFloat(y.bW)));
		case 1:
			var x = cmd.a;
			var y = cmd.b;
			return 'M ' + ($elm$core$String$fromFloat(x.bW) + (',' + $elm$core$String$fromFloat(y.bW)));
		case 2:
			var x = cmd.a;
			var y = cmd.b;
			return 'l ' + ($elm$core$String$fromFloat(x.bW) + (',' + $elm$core$String$fromFloat(y.bW)));
		case 3:
			var x = cmd.a;
			var y = cmd.b;
			return 'L ' + ($elm$core$String$fromFloat(x.bW) + (',' + $elm$core$String$fromFloat(y.bW)));
		case 4:
			var a = cmd.a;
			return 'h ' + $elm$core$String$fromFloat(a.bW);
		case 5:
			var a = cmd.a;
			return 'H ' + $elm$core$String$fromFloat(a.bW);
		case 6:
			var a = cmd.a;
			return 'v ' + $elm$core$String$fromFloat(a.bW);
		case 7:
			var a = cmd.a;
			return 'V ' + $elm$core$String$fromFloat(a.bW);
		case 8:
			...
			var c1x = _v3.a;
			var c1y = _v3.b;
			return 'c ' + ($elm$core$String$fromFloat(c1x.bW) + (' ' + ($elm$core$String$fromFloat(c1y.bW) + (', ' + ($elm$core$String$fromFloat(c2x.bW) + (' ' + ($elm$core$String$fromFloat(c2y.bW) + (', ' + ($elm$core$String$fromFloat(p1x.bW) + (' ' + $elm$core$String$fromFloat(p1y.bW)))))))))));
		case 9:
			var control1 = cmd.a.ae;
			var control2 = cmd.a.af;
			var point = cmd.a.H;
		...
		case 10:
			...
			var c1x = _v8.a;
			var c1y = _v8.b;
			return 'q ' + ($elm$core$String$fromFloat(c1x.bW) + (' ' + ($elm$core$String$fromFloat(c1y.bW) + (', ' + ($elm$core$String$fromFloat(p1x.bW) + (' ' + $elm$core$String$fromFloat(p1y.bW)))))));
		case 11:
			var control = cmd.a.ad;
			var point = cmd.a.H;
			var _v9 = point;
		...
		case 16:
			var arc = cmd.a;
			var deltaAngle = arc.ai.bW - arc.am.bW;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				var dy = arc.al.bW * $elm$core$Basics$sin(
					$elm$core$Basics$degrees(arc.am.bW));
				var dx = arc.al.bW * $elm$core$Basics$cos(
					$elm$core$Basics$degrees(arc.am.bW));
				return 'A ' + ($elm$core$String$fromFloat(arc.al.bW) + (',' + ($elm$core$String$fromFloat(arc.al.bW) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bs.bW - dx) + (',' + ($elm$core$String$fromFloat(arc.bt.bW - dy) + (' A ' + ($elm$core$String$fromFloat(arc.al.bW) + (',' + ($elm$core$String$fromFloat(arc.al.bW) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bs.bW + dx) + (',' + $elm$core$String$fromFloat(arc.bt.bW + dy)))))))))))))));
			} else {
				return 'A ' + ($elm$core$String$fromFloat(arc.al.bW) + (',' + ($elm$core$String$fromFloat(arc.al.bW) + (' 0 ' + (((deltaAngle >= 180) ? '1' : '0') + (' ' + ('1' + (' ' + ($elm$core$String$fromFloat(
					arc.bs.bW + (arc.al.bW * $elm$core$Basics$cos(
						$elm$core$Basics$degrees(arc.ai.bW)))) + (',' + $elm$core$String$fromFloat(
					arc.bt.bW + (arc.al.bW * $elm$core$Basics$sin(
						$elm$core$Basics$degrees(arc.ai.bW))))))))))))));
			}
		case 17:
			var arc = cmd.a;
			var deltaAngle = arc.ai.bW - arc.am.bW;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				...
				var dx = arc.al.bW * $elm$core$Basics$cos(
					$elm$core$Basics$degrees(arc.am.bW));
				return 'A ' + ($elm$core$String$fromFloat(arc.al.bW) + (',' + ($elm$core$String$fromFloat(arc.al.bW) + (',0,1,0,' + ($elm$core$String$fromFloat(arc.bs.bW - dx) + (',' + ($elm$core$String$fromFloat(arc.bt.bW - dy) + (' A ' + ($elm$core$String$fromFloat(arc.al.bW) + (',' + ($elm$core$String$fromFloat(arc.al.bW) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bs.bW + dx) + (',' + $elm$core$String$fromFloat(arc.bt.bW + dy)))))))))))))));
			} else {
				return 'A ' + ($elm$core$String$fromFloat(arc.al.bW) + (',' + ($elm$core$String$fromFloat(arc.al.bW) + (' 0 ' + ((((arc.am.bW - arc.ai.bW) >= 180) ? '1' : '0') + (' ' + ('0' + (' ' + ($elm$core$String$fromFloat(
					arc.bs.bW + (arc.al.bW * $elm$core$Basics$cos(arc.ai.bW))) + (',' + $elm$core$String$fromFloat(
					arc.bt.bW + (arc.al.bW * $elm$core$Basics$sin(arc.ai.bW)))))))))))));
			}
		default:
			return 'z';
	}
		...
		switch (prop.$) {
			...
			case 1:
				...
				return 'rgba(' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(r.bW)) + (',' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(g.bW)) + (',' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(b.bW)) + (',' + ($elm$core$String$fromFloat(a.bW) + ')')))))));
			case 2:
				var name = prop.a;
				var inset = prop.b;
				var shadow = prop.c;
				return (inset ? 'inset ' : '') + ($elm$core$String$fromFloat(shadow.D.bW) + ('px' + (' ' + ($elm$core$String$fromFloat(shadow.E.bW) + ('px' + (' ' + ($elm$core$String$fromFloat(shadow.B.bW) + ('px' + (' ' + ((((name === 'text-shadow') || (name === 'drop-shadow')) ? '' : ($elm$core$String$fromFloat(shadow.I.bW) + ('px' + ' '))) + ('rgba(' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.av.bW)) + (', ' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.au.bW)) + (', ' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.as.bW)) + (', ' + ($elm$core$String$fromFloat(shadow.ar.bW) + ')'))))))))))))))))));
			case 3:
				var x = prop.b;
				return _Utils_ap(
					$elm$core$String$fromFloat(x.bW),
					x.b0);
			case 4:
				var x = prop.b;
				var y = prop.c;
				return _Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							delim,
							_Utils_ap(
								$elm$core$String$fromFloat(y.bW),
								y.b0))));
			case 5:
				var x = prop.b;
				var y = prop.c;
							...
							_Utils_ap(
								...
								_Utils_ap(
									...
									_Utils_ap(
										delim,
										_Utils_ap(
											$elm$core$String$fromFloat(z.bW),
											z.b0)))))));
			case 6:
				var w = prop.b;
				var x = prop.c;
				...
				var z = prop.e;
				return _Utils_ap(
					$elm$core$String$fromFloat(w.bW),
					_Utils_ap(
						w.b0,
						_Utils_ap(
							delim,
...
var $mdgriffith$elm_style_animation$Animation$Render$render3dRotation = function (prop) {
	if (prop.$ === 5) {
		...
		var y = prop.c;
		var z = prop.d;
		return 'rotateX(' + ($elm$core$String$fromFloat(x.bW) + (x.b0 + (') rotateY(' + ($elm$core$String$fromFloat(y.bW) + (y.b0 + (') rotateZ(' + ($elm$core$String$fromFloat(z.bW) + (z.b0 + ')'))))))));
	} else {
		return '';
	}
};
var $mdgriffith$elm_style_animation$Animation$Render$renderValues = function (_v0) {
	var model = _v0;
	var _v1 = A2($elm$core$List$partition, $mdgriffith$elm_style_animation$Animation$Render$isAttr, model.bm);
	var attrProps = _v1.a;
	...
	function (model, key) {
		return A2(
			...
			A2(
				...
				A2($elm$core$Dict$get, key, model.h)));
	});
...
var $author$project$Page$viewPage = F3(
	function (config, state, lines) {
		...
		var nEmptyLines = config.W - $elm$core$List$length(culledLines);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
								...
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('add-habit'),
											$elm$html$Html$Events$onClick(
											config.X($author$project$Page$OpenOptions))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('-')
...
var $author$project$Main$viewEditingPage = F2(
	function (model, screen) {
		var title = A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Dict$get, 'description', screen.o));
		var pageState = {Y: 0};
		var pageConfig = {
			U: _Utils_Tuple2(
				$author$project$Main$emptyDiv,
			...
			W: $author$project$Main$pageLines,
			X: $author$project$Main$PageAction,
			_: false,
			R: 'edit \"' + (title + '\"')
		};
...
var $author$project$Main$viewEmptyPage = function (model) {
	var pageState = {Y: 0};
	var pageConfig = {
		U: _Utils_Tuple2($author$project$Main$emptyDiv, $author$project$Main$emptyDiv),
		W: $author$project$Main$pageLines,
		X: $author$project$Main$PageAction,
		_: false,
		R: ''
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Main$DoSelectHabit(habit.bG))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_Utils_eq(habit.bG, selected) ? $elm$html$Html$Attributes$class('selected') : $elm$html$Html$Attributes$class('not-selected')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(habit.bA)
							]))
					])));
	});
var $author$project$Main$viewHabitSelectPage = F2(
	function (model, screen) {
		var pageState = {Y: screen.A};
		var pageConfig = {
			U: _Utils_Tuple2(
				$author$project$Main$emptyDiv,
				A2(
		...
		var lines = A2(
			...
			A2(
				...
				screen.ax,
				{bA: 'last time', bG: $elm$core$Maybe$Nothing}),
			A2(
				$elm$core$List$map,
				$author$project$Main$habitSelectLine(screen.ax),
				A2(
					$elm$core$List$map,
					function (h) {
						return {
							bA: h.bA,
							bG: $elm$core$Maybe$Just(h.bG)
						};
					},
					A2(
...
var $author$project$Main$isDue = F2(
	function (time, habit) {
		return _Utils_cmp(
			$elm$time$Time$posixToMillis(habit.bQ),
...
var $author$project$Main$isDueSoon = F2(
	function (_v0, habit) {
		...
		return A2(
			...
			A2($author$project$Period$addToPosix, options.u, time),
			habit);
	});
var $author$project$Main$shouldBeMarkedAsDone = F2(
	function (model, habit) {
		return $author$project$Habit$isBlocked(habit) ? true : ((_Utils_cmp(
			$author$project$Period$toMillis(habit.bV),
			$author$project$Period$toMillis(model.g.u)) > 0) ? (!A2($author$project$Main$isDueSoon, model, habit)) : (!A2($author$project$Main$isDue, model.m, habit)));
	});
var $author$project$Main$habitOrderer = F2(
	function (model, habit) {
		return A2($author$project$Main$shouldBeMarkedAsDone, model, habit) ? $elm$time$Time$posixToMillis(
			A2($elm$core$Maybe$withDefault, model.m, habit.bM)) : ((-1) * ($elm$time$Time$posixToMillis(habit.bQ) - $elm$time$Time$posixToMillis(model.m)));
	});
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Main$OpenHabitEdit(habit.bG))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('...')
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Main$DoHabit(habit.bG))
					]),
				_List_fromArray(
					[
						A2(
				...
				function (l) {
					return _Utils_cmp(
						...
						$elm$time$Time$posixToMillis(
							A2($author$project$Period$minusFromPosix, options.x, time))) > 0;
				},
				habit.bM));
	});
...
var $author$project$Main$viewHabitsListPage = F2(
	function (model, habitListScreen) {
		var pageState = {Y: habitListScreen.A};
		var pageConfig = {
			U: _Utils_Tuple2(
				A2(
					$elm$html$Html$button,
	...
	function (model, screen) {
		...
		var lines = _List_fromArray(
			[
				...
				_Utils_Tuple2(
				A2($author$project$Main$periodOptionsView, screen.u, 'upcoming-list'),
				A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value(screen.u),
				...
				_Utils_Tuple2(
				A2($author$project$Main$periodOptionsView, screen.x, 'recent-list'),
				A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value(screen.x),
...
var $author$project$Main$viewScreenTransition = F2(
	function (model, _v0) {
		var transition = _v0;
		var _v1 = function () {
			var _v2 = transition.ag;
			if (!_v2) {
				return _Utils_Tuple2(model.b, transition.Z);
			} else {
				return _Utils_Tuple2(transition.Z, model.b);
			}
		}();
		var top = _v1.a;
		var bottom = _v1.b;
...
var $author$project$Main$maybeViewTransition = function (model) {
	...
	if (_v0.$ === 1) {
		return A2(
			...
			_List_fromArray(
				[
					A2($author$project$Main$viewScreen, model, model.b)
				]));
	} else {
