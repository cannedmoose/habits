...
var $author$project$Main$defaultOptions = {
	w: $author$project$Period$Hours(12),
	k: _List_Nil,
...
var $author$project$Main$Options = F3(
	function (recent, upcoming, seenModals) {
		return {w: recent, k: seenModals, x: upcoming};
	});
...
var $author$project$Main$init = function (flags) {
	var time = $elm$time$Time$millisToPosix(flags.q);
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'recent',
				$author$project$Period$encode(options.w)),
				_Utils_Tuple2(
				'upcoming',
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($author$project$HabitStore$deltasFromDict, model.q, model.e))),
				_Utils_Tuple2(
				'version',
				$elm$json$Json$Encode$int(0))
			]));
		...
		return A2(
			...
			function (habit) {
				return $author$project$Main$EditHabit(
					{
						r: _List_Nil,
						n: $author$project$Main$habitToFields(habit),
						aj: habitId,
						p: model.b
					});
			},
				...
				case 5:
					...
					var newStore = A2(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$map,
								A2($author$project$HabitStore$doHabitDeltas, model.e, model.q),
								A2($elm$core$Dict$get, habitId, model.e))));
							...
							_Utils_update(
								model,
								{
									b: $author$project$Main$SelectHabit(
										{at: forHabit, A: 0, p: model.b, ax: selected})
								})),
						$elm$core$Platform$Cmd$none);
				case 11:
					var _v9 = _v0.b;
							...
							_Utils_update(
								model,
								{
									b: $author$project$Main$CreateHabit(
										{
											r: _List_Nil,
											n: $author$project$Main$habitToFields(
				...
				case 7:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							...
							model.e,
							A3($author$project$HabitStore$deleteHabitDeltas, model.e, model.q, screen.aj));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
				...
				case 8:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							$author$project$HabitStore$applyDeltas,
							model.e,
							A4($author$project$HabitStore$editHabitDeltas, model.e, model.q, screen.aj, screen.r));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
									$author$project$Main$flipOffRight,
							...
							if (!maybeHabitId.$) {
								...
								return _Utils_update(
									screen,
									{
										...
										n: A3($elm$core$Dict$insert, 'block', habitId, screen.n)
									});
							} else {
								return _Utils_update(
									screen,
									{
										r: A2(
											...
											screen.r,
											$author$project$HabitStore$BlockChange($author$project$Habit$Unblocked)),
										n: A2($elm$core$Dict$remove, 'block', screen.n)
									});
							}
						};
						return _Utils_Tuple2(
					...
					if (_v0.a.$ === 2) {
						...
						if (maybeId.$ === 1) {
							...
							var newStore = A2(
								$author$project$HabitStore$applyDeltas,
								model.e,
								A4($author$project$HabitStore$addHabitDeltas, model.e, model.q, id, screen.r));
							return $author$project$Main$storeModel(
								_Utils_Tuple2(
									A2(
										$author$project$Main$flipOffRight,
				...
				case 13:
					if (_v0.a.$ === 4) {
						...
						var updatedOptions = _Utils_update(
							options,
							{
								w: $author$project$Period$parse(screen.w),
								...
								_Utils_update(
									model,
									{
										b: $author$project$Main$EditOptions(
											{
												p: model.b,
												w: $author$project$Period$toString(model.g.w),
	...
	function (_v0, habit) {
		...
		return _Utils_cmp(
			...
			$elm$time$Time$posixToMillis(
				A2($author$project$Period$addToPosix, options.x, time))) < 0;
	});
...
var $author$project$Main$habitOrderer = F2(
	function (model, habit) {
		return A2($author$project$Main$shouldBeMarkedAsDone, model, habit) ? $elm$time$Time$posixToMillis(
			A2($elm$core$Maybe$withDefault, model.q, habit.bM)) : ((-1) * ($elm$time$Time$posixToMillis(habit.bQ) - $elm$time$Time$posixToMillis(model.q)));
	});
			...
			A2(
				...
				function (l) {
					return _Utils_cmp(
						...
						$elm$time$Time$posixToMillis(
							A2($author$project$Period$minusFromPosix, options.w, time))) > 0;
				},
				habit.bM));
	});
	...
	function (model, screen) {
		...
		var lines = _List_fromArray(
			[
				...
				_Utils_Tuple2(
				A2($author$project$Main$periodOptionsView, screen.x, 'upcoming-list'),
				A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
				...
				_Utils_Tuple2(
				A2($author$project$Main$periodOptionsView, screen.w, 'recent-list'),
				A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value(screen.w),
