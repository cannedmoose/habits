...
{
	if (region.aB.al === region.aN.al)
	{
		return 'on line ' + region.aB.al;
	}
	return 'on lines ' + region.aB.al + ' through ' + region.aN.al;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aR: fragment, aU: host, a$: path, a2: port_, a7: protocol, a8: query};
	});
...
var $author$project$HabitStore$emptyHabit = function (id) {
	return {
		at: $author$project$Habit$Unblocked,
		bu: '',
		bv: 0,
		bC: id,
		bI: $elm$core$Maybe$Nothing,
		bM: $elm$time$Time$millisToPosix(0),
		bR: A2($author$project$Period$fromString, 1, 'Day'),
		bW: ''
	};
};
...
var $author$project$Main$StorageModel = F3(
	function (options, habits, version) {
		return {e: habits, s: options, b$: version};
	});
var $author$project$Main$defaultOptions = {
	y: $author$project$Period$Hours(12),
	A: $author$project$Period$Hours(12)
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aJ: s.aJ + (newOffset - s.b), d: s.d, f: s.f, b: newOffset, bc: s.bc, a: s.a};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aJ: col, bt: contextStack, a3: problem, bc: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bc, s.aJ, x, s.d));
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bc, s.aJ - (floatOffset + s.b), invalid, s.d));
		} else {
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bc, s.aJ, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aJ: newCol, d: s.d, f: s.f, b: newOffset, bc: newRow, a: s.a});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aJ: col, d: s0.d, f: s0.f, b: offset, bc: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bc, s.aJ, s);
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aJ: col, a3: problem, bc: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bc, p.aJ, p.a3);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aJ: 1, d: _List_Nil, f: 1, b: 0, bc: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$init = function (flags) {
	var time = $elm$time$Time$millisToPosix(flags.o);
	var storage = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$storageDecoder, flags.ax);
	...
	return _Utils_Tuple2(
		{
			...
			c: $author$project$Main$HabitList(
				{H: 0}),
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {ay: oldTime, ba: request, bi: subs};
	});
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {a5: processes, bj: taggers};
	});
	...
	function (store, time, habit) {
		var blockedHabits = $elm$core$Dict$keys(
			A2(
				...
				F2(
					function (k, h) {
						return A2($author$project$Habit$isBlocker, habit.bC, h) && $author$project$Habit$isBlocked(h);
					}),
				store));
		return _Utils_ap(
			_List_fromArray(
				[
					A2($author$project$HabitStore$Group, time, 'do ' + habit.bC),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.bC,
					...
					habit.bC,
					$author$project$HabitStore$NextDueChange(
						A2($author$project$Period$addToPosix, habit.bR, time))),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.bC,
					$author$project$HabitStore$DoneCountChange(habit.bv + 1)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.bC,
					$author$project$HabitStore$BlockChange(
						$author$project$Habit$doUnblock(habit.at)))
				]),
			A2(
				$elm$core$List$map,
				function (habitId) {
					return A2(
						...
						habitId,
						$author$project$HabitStore$BlockChange(
							A2($author$project$Habit$Blocker, habit.bC, false)));
				},
				blockedHabits));
	});
...
var $author$project$Main$habitToFields = function (habit) {
	...
	return $elm$core$Dict$fromList(
		_Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2('description', habit.bu),
					_Utils_Tuple2('tag', habit.bW),
					_Utils_Tuple2(
					'period',
					$author$project$Period$toString(habit.bR))
				]),
			blocker));
};
		...
		return A2(
			...
			function (habit) {
				return $author$project$Main$EditHabit(
					{
						p: _List_Nil,
						l: $author$project$Main$habitToFields(habit),
						ak: habitId,
						n: model.c
					});
			},
...
var $mdgriffith$elm_style_animation$Animation$initMotion = F2(
	function (position, unit) {
		return {
			ac: $mdgriffith$elm_style_animation$Animation$Model$Spring(
				{aL: 26, bh: 170}),
...
var $mdgriffith$elm_style_animation$Animation$easing = function (_v0) {
	...
	return $mdgriffith$elm_style_animation$Animation$Model$Easing(
		{
			by: $elm$time$Time$millisToPosix(
...
var $author$project$Main$slideEase = $mdgriffith$elm_style_animation$Animation$easing(
	{by: 400, bz: $elm_community$easing_functions$Ease$inOutCubic});
...
var $mdgriffith$elm_style_animation$Animation$defaultInterpolationByProperty = function (prop) {
	var linear = function (duration) {
		return $mdgriffith$elm_style_animation$Animation$Model$Easing(
			{by: duration, bz: $elm$core$Basics$identity, a6: 1, aB: 0});
	};
	...
	switch (prop.$) {
		...
		case 5:
			...
			return (name === 'rotate3d') ? $mdgriffith$elm_style_animation$Animation$speed(
				{a0: $elm$core$Basics$pi}) : defaultSpring;
		case 6:
			return defaultSpring;
		case 7:
			return $mdgriffith$elm_style_animation$Animation$speed(
				{a0: $elm$core$Basics$pi});
		case 8:
			return defaultSpring;
		default:
			return defaultSpring;
		...
		switch (cmd.$) {
			...
			case 7:
				...
				return $mdgriffith$elm_style_animation$Animation$Model$VerticalTo(
					fn(motion));
			case 8:
				var control1 = cmd.a.ah;
				var control2 = cmd.a.ai;
				var point = cmd.a.I;
	...
	function (fn, prop) {
		switch (prop.$) {
			...
			case 2:
				...
				var size = shadow.J;
				var red = shadow.z;
				var offsetY = shadow.F;
				var offsetX = shadow.E;
				var green = shadow.x;
				var blur = shadow.C;
				var blue = shadow.u;
				var alpha = shadow.t;
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$DescriptionChange(habit.bu)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$TagChange(habit.bW)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$NextDueChange(habit.bM)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$DoneCountChange(habit.bv)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$BlockChange(habit.at))
				]),
			function () {
				var _v0 = habit.bI;
				if (!_v0.$) {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'recent',
				$author$project$Period$encode(options.y)),
				_Utils_Tuple2(
				'upcoming',
				$author$project$Period$encode(options.A))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'options',
				$author$project$Main$optionsEncoder(model.s)),
				_Utils_Tuple2(
				'habits',
				A2(
					$elm$json$Json$Encode$list,
					$author$project$HabitStore$encode,
					A2($author$project$HabitStore$deltasFromDict, model.o, model.e))),
				_Utils_Tuple2(
				'version',
				$elm$json$Json$Encode$int(0))
			]));
...
var $mdgriffith$elm_style_animation$Animation$Model$refreshTiming = F2(
	function (now, timing) {
		...
		return {
			aK: now,
			bx: ((dt > 34) || (!$elm$time$Time$posixToMillis(timing.aK))) ? $elm$time$Time$millisToPosix(
...
var $mdgriffith$elm_style_animation$Animation$Model$isCmdDone = function (cmd) {
	var motionDone = function (motion) {
		return (!motion.b_) && _Utils_eq(motion.bS, motion.bX);
	};
	switch (cmd.$) {
		case 0:
			var m1 = cmd.a;
		...
		case 16:
			var arc = cmd.a;
			return motionDone(arc.bm) && (motionDone(arc.bn) && (motionDone(arc.am) && (motionDone(arc.an) && motionDone(arc.aj))));
		case 17:
			var arc = cmd.a;
			return motionDone(arc.bm) && (motionDone(arc.bn) && (motionDone(arc.am) && (motionDone(arc.an) && motionDone(arc.aj))));
		default:
...
var $mdgriffith$elm_style_animation$Animation$Model$isDone = function (property) {
	var motionDone = function (motion) {
		var runningInterpolation = A2($elm$core$Maybe$withDefault, motion.ac, motion.bG);
		switch (runningInterpolation.$) {
			case 0:
				return (!motion.b_) && _Utils_eq(motion.bS, motion.bX);
			case 1:
				var eased = runningInterpolation.a;
				return (eased.a6 === 1) || ((!eased.a6) && _Utils_eq(motion.bS, motion.bX));
			default:
				var speed = runningInterpolation.a;
				return _Utils_eq(motion.bS, motion.bX);
		}
	};
	switch (property.$) {
		case 0:
		...
		case 2:
			...
			return A2(
				...
				motionDone,
				_List_fromArray(
					[shadow.E, shadow.F, shadow.J, shadow.C, shadow.z, shadow.x, shadow.u, shadow.t]));
		case 3:
			var m1 = property.b;
			...
			function (motion, targetMotion) {
				...
				if (_v27.$ === 1) {
					...
					return _Utils_update(
						motion,
						{
							ac: $mdgriffith$elm_style_animation$Animation$Model$Easing(
								_Utils_update(
									ease,
									{aB: motion.bS})),
							bX: targetMotion.bS
					...
					return $mdgriffith$elm_style_animation$Animation$Model$Curve(
						{
							...
							I: _Utils_Tuple2(
								A2(setMotionTarget, points.I.a, targets.I.a),
								A2(setMotionTarget, points.I.b, targets.I.b))
						});
				} else {
					return cmd;
				}
			...
			case 10:
				...
				if (targetCmd.$ === 10) {
					...
					return $mdgriffith$elm_style_animation$Animation$Model$Quadratic(
						{
							ag: _Utils_Tuple2(
								A2(setMotionTarget, points.ag.a, targets.ag.a),
								A2(setMotionTarget, points.ag.b, targets.ag.b)),
							I: _Utils_Tuple2(
								A2(setMotionTarget, points.I.a, targets.I.a),
								A2(setMotionTarget, points.I.b, targets.I.b))
						});
					...
					return $mdgriffith$elm_style_animation$Animation$Model$ClockwiseArc(
						function () {
							...
							return _Utils_update(
								arc,
								{
									aj: A2(setMotionTarget, endAngle, target.aj),
									am: A2(setMotionTarget, radius, target.am),
									an: A2(setMotionTarget, startAngle, target.an),
									bm: A2(setMotionTarget, x, target.bm),
									bn: A2(setMotionTarget, y, target.bn)
								});
						}());
				} else {
					return cmd;
		...
		var setMotionTarget = F2(
			function (motion, targetMotion) {
				var newMotion = overrideInterpolation ? _Utils_update(
					motion,
					{
						bG: $elm$core$Maybe$Just(targetMotion.ac)
					}) : motion;
				var _v13 = newMotion.bG;
				if (_v13.$ === 1) {
					var _v14 = newMotion.ac;
					if (_v14.$ === 1) {
						var ease = _v14.a;
						return _Utils_update(
							newMotion,
...
var $mdgriffith$elm_style_animation$Animation$Model$stepInterpolation = F2(
	function (posix, motion) {
		var interpolationToUse = A2($elm$core$Maybe$withDefault, motion.ac, motion.bG);
		var dtms = $elm$time$Time$posixToMillis(posix);
		switch (interpolationToUse.$) {
			case 2:
				var perSecond = interpolationToUse.a.a0;
				var _v1 = function () {
					if (_Utils_cmp(motion.bS, motion.bX) < 0) {
						var _new = motion.bS + (perSecond * (dtms / 1000));
						return _Utils_Tuple2(
							_new,
							_Utils_cmp(_new, motion.bX) > -1);
					} else {
						var _new = motion.bS - (perSecond * (dtms / 1000));
						return _Utils_Tuple2(
							_new,
				...
				return finished ? _Utils_update(
					motion,
					{bS: motion.bX, b_: 0.0}) : _Utils_update(
					motion,
					{bS: newPos, b_: perSecond * 1000});
			case 0:
				var stiffness = interpolationToUse.a.bh;
				var damping = interpolationToUse.a.aL;
				var fspring = stiffness * (motion.bX - motion.bS);
				var fdamper = ((-1) * damping) * motion.b_;
				var dt = dtms / 1000;
				var a = fspring + fdamper;
				var newVelocity = motion.b_ + (a * dt);
				var newPos = motion.bS + (newVelocity * dt);
				var dx = $elm$core$Basics$abs(motion.bX - newPos);
				return ((_Utils_cmp(dx, $mdgriffith$elm_style_animation$Animation$Model$tolerance) < 0) && (_Utils_cmp(
					...
					{bS: motion.bX, b_: 0.0}) : _Utils_update(
					motion,
					{bS: newPos, b_: newVelocity});
			default:
				var progress = interpolationToUse.a.a6;
				var duration = interpolationToUse.a.by;
				var ease = interpolationToUse.a.bz;
				var start = interpolationToUse.a.aB;
				...
				var distance = motion.bX - start;
				var newPos = ((((eased * distance) + start) * 10000) | 0) / 10000;
				var newVelocity = (newProgress === 1) ? 0 : ((newPos - motion.bS) / dtms);
				var _v2 = motion.bG;
				if (_v2.$ === 1) {
					return _Utils_update(
						motion,
						{
							ac: $mdgriffith$elm_style_animation$Animation$Model$Easing(
								{by: duration, bz: ease, a6: newProgress, aB: start}),
							bS: newPos,
							b_: newVelocity
						});
				} else {
			...
			case 16:
				...
				return $mdgriffith$elm_style_animation$Animation$Model$ClockwiseArc(
					_Utils_update(
						arc,
						{
							aj: A2($mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.aj),
							...
							bm: A2($mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.bm),
...
var $mdgriffith$elm_style_animation$Animation$Model$updateAnimation = F2(
	function (_v0, _v1) {
		var now = _v0;
		var model = _v1;
		var timing = A2($mdgriffith$elm_style_animation$Animation$Model$refreshTiming, now, model.bk);
		var _v2 = A2(
			$elm$core$List$partition,
			function (_v4) {
				var wait = _v4.a;
			...
			A2(
				...
				function (_v3) {
					...
					return _Utils_Tuple2(
						$elm$time$Time$millisToPosix(
							$elm$time$Time$posixToMillis(wait) - $elm$time$Time$posixToMillis(timing.bx)),
						mySteps);
				},
				model.av));
		...
		var _v5 = function () {
			...
			if (!_v6.$) {
				...
				return _Utils_Tuple2(model.aC, model.M);
			}
		}();
		var steps = _v5.a;
		var style = _v5.b;
		var _v8 = A3($mdgriffith$elm_style_animation$Animation$Model$resolveSteps, style, steps, timing.bx);
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					av: queuedInterruptions,
					as: (!(!$elm$core$List$length(revisedSteps))) || (!(!$elm$core$List$length(queuedInterruptions))),
					aC: revisedSteps,
					M: revisedStyle,
					bk: timing
				}),
			...
			case 'description':
				return _Utils_update(
					page,
					{
						...
						l: A3($elm$core$Dict$insert, 'description', val, page.l)
					});
			case 'tag':
				return _Utils_update(
					page,
					{
						...
						l: A3($elm$core$Dict$insert, 'tag', val, page.l)
					});
			case 'period':
				return _Utils_update(
					page,
					{
						...
						l: A3($elm$core$Dict$insert, 'period', val, page.l)
					});
			default:
				return page;
		}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(model.c, msg);
		_v0$22:
		while (true) {
			switch (_v0.b.$) {
				case 0:
				...
				case 3:
					...
					if (_v2.$ === 1) {
						...
						var _v3 = A2($mdgriffith$elm_style_animation$Animation$Messenger$update, animMsg, transition.M);
						var style = _v3.a;
						var cmd = _v3.b;
						return _Utils_Tuple2(
							_Utils_update(
				...
				case 5:
					...
					var newStore = A2(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$map,
								A2($author$project$HabitStore$doHabitDeltas, model.e, model.o),
								A2($elm$core$Dict$get, habitId, model.e))));
				...
				case 9:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								c: $author$project$Main$SelectHabit(
									{au: '\"' + (_for + '\"'), H: 0, n: model.c, be: habitId}),
								h: $elm$core$Maybe$Just(
									$author$project$Main$flipOn(model))
							}),
						$elm$core$Platform$Cmd$none);
				case 11:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								c: $author$project$Main$CreateHabit(
									{
										p: _List_Nil,
										l: $author$project$Main$habitToFields(
				...
				case 13:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								c: $author$project$Main$EditOptions(
									{
										n: model.c,
										y: $author$project$Period$toString(model.s.y),
										A: $author$project$Period$toString(model.s.A)
									}),
								h: $elm$core$Maybe$Just(
									$author$project$Main$slideFromTopTransition(model))
							}),
				...
				case 7:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							...
							model.e,
							A3($author$project$HabitStore$deleteHabitDeltas, model.e, model.o, screen.ak));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								_Utils_update(
									model,
				...
				case 8:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							$author$project$HabitStore$applyDeltas,
							model.e,
							A4($author$project$HabitStore$editHabitDeltas, model.e, model.o, screen.ak, screen.p));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								_Utils_update(
									model,
							...
							if (!maybeHabitId.$) {
								...
								return _Utils_update(
									screen,
									{
										...
										l: A3($elm$core$Dict$insert, 'block', habitId, screen.l)
									});
							} else {
								return _Utils_update(
									screen,
									{
										p: A2(
											...
											screen.p,
											$author$project$HabitStore$BlockChange($author$project$Habit$Unblocked)),
										l: A2($elm$core$Dict$remove, 'block', screen.l)
									});
							}
						};
						return _Utils_Tuple2(
					...
					if (_v0.a.$ === 2) {
						...
						if (maybeId.$ === 1) {
							...
							var newStore = A2(
								$author$project$HabitStore$applyDeltas,
								model.e,
								A4($author$project$HabitStore$addHabitDeltas, model.e, model.o, id, screen.p));
							return $author$project$Main$storeModel(
								_Utils_Tuple2(
									_Utils_update(
										model,
				...
				case 14:
					if (_v0.a.$ === 4) {
						...
						var updatedOptions = _Utils_update(
							options,
							{
								y: $author$project$Period$parse(screen.y),
								A: $author$project$Period$parse(screen.A)
							});
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								_Utils_update(
						...
						case 1:
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										c: $author$project$Main$EditHabit(
									...
									model,
									{
										c: $author$project$Main$HabitList(
											_Utils_update(
												...
												{H: page})),
										h: $elm$core$Maybe$Just(
											(_Utils_cmp(page, screen.H) < 0) ? $author$project$Main$flipOffRight(model) : $author$project$Main$flipOn(model))
									}),
								$elm$core$Platform$Cmd$none);
						case 3:
							var screen = _v0.a.a;
...
var $author$project$Main$Cancel = {$: 17};
...
var $author$project$Main$editPagelines = F2(
	function (model, screen) {
		return A3(
			...
			$elm$core$Maybe$Just(screen.ak));
	});
var $author$project$Main$pageLines = 18;
var $author$project$Main$OpenEditOptions = {$: 13};
...
var $author$project$Main$viewPage = F3(
	function (config, state, lines) {
		...
		var nEmptyLines = config.K - $elm$core$List$length(culledLines);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Main$viewEditingPage = F2(
	function (model, screen) {
		var title = A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Dict$get, 'description', screen.l));
		var pageState = {Q: 0};
		var pageConfig = {
			U: _Utils_Tuple2(
				$author$project$Main$emptyDiv,
			...
			K: $author$project$Main$pageLines,
			Y: false,
			S: 'edit \"' + (title + '\"')
		};
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(habit.bW)
							]))
					])));
	});
var $author$project$Main$viewHabitSelectPage = F2(
	function (model, screen) {
		var pageState = {Q: screen.H};
		var pageConfig = {
			U: _Utils_Tuple2(
				$author$project$Main$emptyDiv,
				A2(
...
var $author$project$Main$isDueSoon = F2(
	function (_v0, habit) {
		...
		var options = _v0.s;
		return _Utils_cmp(
			$elm$time$Time$posixToMillis(habit.bM),
			$elm$time$Time$posixToMillis(
				A2($author$project$Period$addToPosix, options.A, time))) < 0;
	});
...
var $author$project$Main$habitOrderer = F2(
	function (model, habit) {
		return A2($author$project$Main$shouldBeMarkedAsDone, model, habit) ? $elm$time$Time$posixToMillis(
			A2($elm$core$Maybe$withDefault, model.o, habit.bI)) : ((-1) * ($elm$time$Time$posixToMillis(habit.bM) - $elm$time$Time$posixToMillis(model.o)));
	});
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Main$OpenHabitEdit(habit.bC))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('...')
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Main$DoHabit(habit.bC))
					]),
				_List_fromArray(
					[
						A2(
			...
			A2(
				...
				function (l) {
					return _Utils_cmp(
						...
						$elm$time$Time$posixToMillis(
							A2($author$project$Period$minusFromPosix, options.y, time))) > 0;
				},
				habit.bI));
	});
...
var $author$project$Main$viewHabitsListPage = F2(
	function (model, habitListScreen) {
		var pageState = {Q: habitListScreen.H};
		var pageConfig = {
			U: _Utils_Tuple2(
				A2(
					$elm$html$Html$button,
...
var $author$project$Main$DoSaveOptions = {$: 14};
	...
	function (model, screen) {
		...
		var lines = _List_fromArray(
			[
				...
				_Utils_Tuple2(
				A2($author$project$Main$periodOptionsView, screen.A, 'upcoming-list'),
				A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value(screen.A),
				...
				_Utils_Tuple2(
				A2($author$project$Main$periodOptionsView, screen.y, 'recent-list'),
				A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value(screen.y),
		...
		return A2(
			...
			A2(
				...
				function (_v11) {
					var x = _v11.a;
					var y = _v11.b;
					return $elm$core$String$fromFloat(x.bS) + (',' + $elm$core$String$fromFloat(y.bS));
				},
				coords));
	};
	switch (cmd.$) {
		case 0:
			var x = cmd.a;
			var y = cmd.b;
			return 'm ' + ($elm$core$String$fromFloat(x.bS) + (',' + $elm$core$String$fromFloat(y.bS)));
		case 1:
			var x = cmd.a;
			var y = cmd.b;
			return 'M ' + ($elm$core$String$fromFloat(x.bS) + (',' + $elm$core$String$fromFloat(y.bS)));
		case 2:
			var x = cmd.a;
			var y = cmd.b;
			return 'l ' + ($elm$core$String$fromFloat(x.bS) + (',' + $elm$core$String$fromFloat(y.bS)));
		case 3:
			var x = cmd.a;
			var y = cmd.b;
			return 'L ' + ($elm$core$String$fromFloat(x.bS) + (',' + $elm$core$String$fromFloat(y.bS)));
		case 4:
			var a = cmd.a;
			return 'h ' + $elm$core$String$fromFloat(a.bS);
		case 5:
			var a = cmd.a;
			return 'H ' + $elm$core$String$fromFloat(a.bS);
		case 6:
			var a = cmd.a;
			return 'v ' + $elm$core$String$fromFloat(a.bS);
		case 7:
			var a = cmd.a;
			return 'V ' + $elm$core$String$fromFloat(a.bS);
		case 8:
			...
			var c1x = _v3.a;
			var c1y = _v3.b;
			return 'c ' + ($elm$core$String$fromFloat(c1x.bS) + (' ' + ($elm$core$String$fromFloat(c1y.bS) + (', ' + ($elm$core$String$fromFloat(c2x.bS) + (' ' + ($elm$core$String$fromFloat(c2y.bS) + (', ' + ($elm$core$String$fromFloat(p1x.bS) + (' ' + $elm$core$String$fromFloat(p1y.bS)))))))))));
		case 9:
			var control1 = cmd.a.ah;
			var control2 = cmd.a.ai;
			var point = cmd.a.I;
		...
		case 10:
			...
			var c1x = _v8.a;
			var c1y = _v8.b;
			return 'q ' + ($elm$core$String$fromFloat(c1x.bS) + (' ' + ($elm$core$String$fromFloat(c1y.bS) + (', ' + ($elm$core$String$fromFloat(p1x.bS) + (' ' + $elm$core$String$fromFloat(p1y.bS)))))));
		case 11:
			var control = cmd.a.ag;
			var point = cmd.a.I;
			var _v9 = point;
		...
		case 16:
			var arc = cmd.a;
			var deltaAngle = arc.aj.bS - arc.an.bS;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				var dy = arc.am.bS * $elm$core$Basics$sin(
					$elm$core$Basics$degrees(arc.an.bS));
				var dx = arc.am.bS * $elm$core$Basics$cos(
					$elm$core$Basics$degrees(arc.an.bS));
				return 'A ' + ($elm$core$String$fromFloat(arc.am.bS) + (',' + ($elm$core$String$fromFloat(arc.am.bS) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bm.bS - dx) + (',' + ($elm$core$String$fromFloat(arc.bn.bS - dy) + (' A ' + ($elm$core$String$fromFloat(arc.am.bS) + (',' + ($elm$core$String$fromFloat(arc.am.bS) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bm.bS + dx) + (',' + $elm$core$String$fromFloat(arc.bn.bS + dy)))))))))))))));
			} else {
				return 'A ' + ($elm$core$String$fromFloat(arc.am.bS) + (',' + ($elm$core$String$fromFloat(arc.am.bS) + (' 0 ' + (((deltaAngle >= 180) ? '1' : '0') + (' ' + ('1' + (' ' + ($elm$core$String$fromFloat(
					arc.bm.bS + (arc.am.bS * $elm$core$Basics$cos(
						$elm$core$Basics$degrees(arc.aj.bS)))) + (',' + $elm$core$String$fromFloat(
					arc.bn.bS + (arc.am.bS * $elm$core$Basics$sin(
						$elm$core$Basics$degrees(arc.aj.bS))))))))))))));
			}
		case 17:
			var arc = cmd.a;
			var deltaAngle = arc.aj.bS - arc.an.bS;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				...
				var dx = arc.am.bS * $elm$core$Basics$cos(
					$elm$core$Basics$degrees(arc.an.bS));
				return 'A ' + ($elm$core$String$fromFloat(arc.am.bS) + (',' + ($elm$core$String$fromFloat(arc.am.bS) + (',0,1,0,' + ($elm$core$String$fromFloat(arc.bm.bS - dx) + (',' + ($elm$core$String$fromFloat(arc.bn.bS - dy) + (' A ' + ($elm$core$String$fromFloat(arc.am.bS) + (',' + ($elm$core$String$fromFloat(arc.am.bS) + (',0,1,1,' + ($elm$core$String$fromFloat(arc.bm.bS + dx) + (',' + $elm$core$String$fromFloat(arc.bn.bS + dy)))))))))))))));
			} else {
				return 'A ' + ($elm$core$String$fromFloat(arc.am.bS) + (',' + ($elm$core$String$fromFloat(arc.am.bS) + (' 0 ' + ((((arc.an.bS - arc.aj.bS) >= 180) ? '1' : '0') + (' ' + ('0' + (' ' + ($elm$core$String$fromFloat(
					arc.bm.bS + (arc.am.bS * $elm$core$Basics$cos(arc.aj.bS))) + (',' + $elm$core$String$fromFloat(
					arc.bn.bS + (arc.am.bS * $elm$core$Basics$sin(arc.aj.bS)))))))))))));
			}
		default:
			return 'z';
	}
		...
		switch (prop.$) {
			...
			case 1:
				...
				return 'rgba(' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(r.bS)) + (',' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(g.bS)) + (',' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(b.bS)) + (',' + ($elm$core$String$fromFloat(a.bS) + ')')))))));
			case 2:
				var name = prop.a;
				var inset = prop.b;
				var shadow = prop.c;
				return (inset ? 'inset ' : '') + ($elm$core$String$fromFloat(shadow.E.bS) + ('px' + (' ' + ($elm$core$String$fromFloat(shadow.F.bS) + ('px' + (' ' + ($elm$core$String$fromFloat(shadow.C.bS) + ('px' + (' ' + ((((name === 'text-shadow') || (name === 'drop-shadow')) ? '' : ($elm$core$String$fromFloat(shadow.J.bS) + ('px' + ' '))) + ('rgba(' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.z.bS)) + (', ' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.x.bS)) + (', ' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(shadow.u.bS)) + (', ' + ($elm$core$String$fromFloat(shadow.t.bS) + ')'))))))))))))))))));
			case 3:
				var x = prop.b;
				return _Utils_ap(
					$elm$core$String$fromFloat(x.bS),
					x.bY);
			case 4:
				var x = prop.b;
				var y = prop.c;
				return _Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							delim,
							_Utils_ap(
								$elm$core$String$fromFloat(y.bS),
								y.bY))));
			case 5:
				var x = prop.b;
				var y = prop.c;
							...
							_Utils_ap(
								...
								_Utils_ap(
									...
									_Utils_ap(
										delim,
										_Utils_ap(
											$elm$core$String$fromFloat(z.bS),
											z.bY)))))));
			case 6:
				var w = prop.b;
				var x = prop.c;
				...
				var z = prop.e;
				return _Utils_ap(
					$elm$core$String$fromFloat(w.bS),
					_Utils_ap(
						w.bY,
						_Utils_ap(
							delim,
...
var $mdgriffith$elm_style_animation$Animation$Render$render3dRotation = function (prop) {
	if (prop.$ === 5) {
		...
		var y = prop.c;
		var z = prop.d;
		return 'rotateX(' + ($elm$core$String$fromFloat(x.bS) + (x.bY + (') rotateY(' + ($elm$core$String$fromFloat(y.bS) + (y.bY + (') rotateZ(' + ($elm$core$String$fromFloat(z.bS) + (z.bY + ')'))))))));
	} else {
		return '';
	}
};
var $mdgriffith$elm_style_animation$Animation$Render$renderValues = function (_v0) {
	var model = _v0;
	var _v1 = A2($elm$core$List$partition, $mdgriffith$elm_style_animation$Animation$Render$isAttr, model.M);
	var attrProps = _v1.a;
...
var $author$project$Main$viewScreenTransition = F2(
	function (model, _v0) {
		var transition = _v0;
		var _v1 = function () {
			var _v2 = transition._;
			if (!_v2) {
				return _Utils_Tuple2(model.c, transition.X);
			} else {
				return _Utils_Tuple2(transition.X, model.c);
			}
		}();
		var top = _v1.a;
		var bottom = _v1.b;
			...
			_List_fromArray(
				[
					...
					A2(
						...
						$mdgriffith$elm_style_animation$Animation$render(transition.M)),
					_List_fromArray(
						[
...
var $author$project$Main$maybeViewTransition = function (model) {
	...
	if (_v0.$ === 1) {
		return A2(
			...
			_List_fromArray(
				[
					A2($author$project$Main$viewScreen, model, model.c)
				]));
	} else {
