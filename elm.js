...
var $author$project$Main$NoScreen = {$: 'NoScreen'};
...
var $author$project$Period$Immediate = {$: 'Immediate'};
...
var $author$project$HabitStore$emptyHabit = function (id) {
	return {
		blocker: $elm$core$Maybe$Nothing,
		description: '',
		doneCount: 0,
		id: id,
		isBlocked: false,
...
var $author$project$Main$Options = F3(
	function (recent, upcoming, seenModals) {
		return {recent: recent, seenModals: seenModals, upcoming: upcoming};
	});
var $author$project$Main$AddingHabitModal = {$: 'AddingHabitModal'};
var $author$project$Main$DoHabitModal = {$: 'DoHabitModal'};
var $author$project$Main$FirstHabitModal = {$: 'FirstHabitModal'};
var $author$project$Main$IntroModal = {$: 'IntroModal'};
var $author$project$Main$OpenOptionsModal = {$: 'OpenOptionsModal'};
var $author$project$Main$modalDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (field) {
		switch (field) {
			case 1:
				return $elm$json$Json$Decode$succeed($author$project$Main$IntroModal);
			case 2:
				return $elm$json$Json$Decode$succeed($author$project$Main$FirstHabitModal);
			case 3:
				return $elm$json$Json$Decode$succeed($author$project$Main$AddingHabitModal);
			case 4:
				return $elm$json$Json$Decode$succeed($author$project$Main$DoHabitModal);
			case 5:
				return $elm$json$Json$Decode$succeed($author$project$Main$OpenOptionsModal);
			default:
				return $elm$json$Json$Decode$succeed($author$project$Main$NoModal);
		}
	},
	$elm$json$Json$Decode$int);
...
var $author$project$Main$init = function (flags) {
	...
	return _Utils_Tuple2(
		{
			animations: $elm$core$Dict$empty,
			...
			screen: $author$project$Main$NoScreen,
...
var $author$project$Main$animationSubscription = function (model) {
	return A2(
		...
		$elm$core$Dict$values(model.animations));
};
...
var $author$project$Main$slideEase2 = $mdgriffith$elm_style_animation$Animation$easing(
	{duration: 700, ease: $elm_community$easing_functions$Ease$inOutCubic});
...
var $author$project$Main$afterDoHabitModalUpdate = function (model) {
	...
	return (!A2($elm$core$List$member, $author$project$Main$OpenOptionsModal, options.seenModals)) ? $author$project$Main$modalInTransition(
		_Utils_update(
			model,
			{
				modal: $author$project$Main$OpenOptionsModal,
				options: _Utils_update(
					options,
					{
						seenModals: A2($elm$core$List$cons, $author$project$Main$OpenOptionsModal, options.seenModals)
					})
			})) : model;
};
var $author$project$Main$ClearTransition = {$: 'ClearTransition'};
var $author$project$Main$ScreenTransition = function (a) {
	return {$: 'ScreenTransition', a: a};
};
...
var $author$project$Main$afterModalModelUpdate = F2(
	function (modal, model) {
		var _v0 = _Utils_Tuple2(model.screen, modal);
		if ((_v0.a.$ === 'NoScreen') && (_v0.b.$ === 'IntroModal')) {
			var _v1 = _v0.a;
			var _v2 = _v0.b;
			return A2(
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$BlockerChange(habit.blocker)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$IsBlockedChange(habit.isBlocked)),
					A2(
					$author$project$HabitStore$ChangeHabit,
					id,
					$author$project$HabitStore$PeriodChange(habit.period))
				]),
			function () {
...
var $author$project$Main$modalEncoder = function (modal) {
	switch (modal.$) {
		...
		case 'FirstHabitModal':
			return $elm$json$Json$Encode$int(2);
		case 'AddingHabitModal':
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'seenModals',
				A2($elm$json$Json$Encode$list, $author$project$Main$modalEncoder, options.seenModals))
			]));
};
...
var $author$project$Main$afterTransitionModalUpdate = function (_v0) {
	...
	switch (_v1.$) {
		case 'HabitList':
			return (!A2($elm$core$List$member, $author$project$Main$FirstHabitModal, options.seenModals)) ? $author$project$Main$storeModel(
				_Utils_Tuple2(
					$author$project$Main$modalInTransition(
						_Utils_update(
							model,
							{
								modal: $author$project$Main$FirstHabitModal,
								options: _Utils_update(
									options,
									{
										seenModals: A2($elm$core$List$cons, $author$project$Main$FirstHabitModal, options.seenModals)
									})
							})),
					cmd)) : (((!A2($elm$core$List$member, $author$project$Main$DoHabitModal, options.seenModals)) && (!$elm$core$Dict$isEmpty(model.habits))) ? $author$project$Main$storeModel(
				_Utils_Tuple2(
					$author$project$Main$modalInTransition(
						_Utils_update(
							model,
							{
								modal: $author$project$Main$DoHabitModal,
								options: _Utils_update(
									options,
									{
										seenModals: A2($elm$core$List$cons, $author$project$Main$DoHabitModal, options.seenModals)
									})
							})),
					cmd)) : _Utils_Tuple2(model, cmd));
		case 'CreateHabit':
			return (!A2($elm$core$List$member, $author$project$Main$AddingHabitModal, options.seenModals)) ? $author$project$Main$storeModel(
				_Utils_Tuple2(
					$author$project$Main$modalInTransition(
						_Utils_update(
							model,
							{
								modal: $author$project$Main$AddingHabitModal,
								options: _Utils_update(
									options,
									{
										seenModals: A2($elm$core$List$cons, $author$project$Main$AddingHabitModal, options.seenModals)
									})
							})),
					cmd)) : _Utils_Tuple2(model, cmd);
		default:
			...
			A2(
				...
				F2(
					function (_v1, h) {
						return _Utils_eq(
							h.blocker,
							$elm$core$Maybe$Just(habit.id)) && h.isBlocked;
					}),
				store));
		return _Utils_ap(
			_List_fromArray(
			...
			_Utils_ap(
				(!_Utils_eq(habit.blocker, $elm$core$Maybe$Nothing)) ? _List_fromArray(
					[
						A2(
						$author$project$HabitStore$ChangeHabit,
						habit.id,
					...
					function (_v0) {
						...
						return _List_fromArray(
							[
								...
								hid,
								$author$project$HabitStore$NextDueChange(
									A2($author$project$Period$addToPosix, h.period, time)))
							]);
					},
					blockedHabits)));
	});
				...
				_List_fromArray(
					[
						...
						$author$project$Period$toString(
							A2($author$project$Period$fromDelta, model.time, habit.nextDue)))
					]),
				blocker));
	});
		...
		return A2(
			...
			function (habit) {
				return $author$project$Main$EditHabit(
					{
						deltas: _List_Nil,
						fields: A2($author$project$Main$habitToFields, model, habit),
						habitId: habitId,
						parent: model.screen
					});
			},
...
var $author$project$Main$fadeEase = $mdgriffith$elm_style_animation$Animation$easing(
	{duration: 1500, ease: $elm_community$easing_functions$Ease$outExpo});
...
var $author$project$Main$shouldBeMarkedAsDone = F2(
	function (model, habit) {
		return habit.isBlocked ? true : ((_Utils_cmp(
			$author$project$Period$toMillis(habit.period),
			$author$project$Period$toMillis(model.options.upcoming)) > 0) ? (!A2($author$project$Main$isDueSoon, model, habit)) : A3($author$project$Main$isDoneWithin, model.time, habit.period, habit));
	});
...
var $author$project$HabitStore$undoHabitDeltas = F3(
	function (store, time, habit) {
		var blockedHabits = $elm$core$Dict$keys(
			A2(
				$elm$core$Dict$filter,
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					habit.id,
					$author$project$HabitStore$LastDoneChange(
						A2($author$project$Period$minusFromPosix, habit.period, time))),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.id,
					$author$project$HabitStore$NextDueChange(time)),
			...
			_Utils_ap(
				habit.isBlocked ? _List_fromArray(
					[
						A2(
						$author$project$HabitStore$ChangeHabit,
						habit.id,
						...
						deltas: A2(
							...
							$author$project$HabitStore$NextDueChange(
								A2(
									...
									model.time)),
							page.deltas),
						fields: A3($elm$core$Dict$insert, 'due', val, page.fields)
					});
			default:
				return page;
		}
...
var $author$project$Main$viewHabitFilter = F2(
	function (model, habit) {
		...
		return habit.isBlocked ? recent : (due || recent);
	});
				...
				case 'UnDoHabit':
					...
					var newStore = A2(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$map,
								A2($author$project$HabitStore$undoHabitDeltas, model.habits, model.time),
								A2($elm$core$Dict$get, habitId, model.habits))));
					return $author$project$Main$storeModel(
						_Utils_Tuple2(
							_Utils_update(
							...
							_Utils_update(
								model,
								{
									animations: A2(
										...
										'modal-bg',
										A2($elm$core$Dict$remove, 'modal-fg', model.animations)),
									modal: $author$project$Main$NoModal
								})),
						$elm$core$Platform$Cmd$none);
				case 'DoDeleteHabit':
								...
								case 'EditHabit':
									...
									return A2(
										...
										A2(
											...
											A2($elm$core$Dict$get, screen.habitId, model.habits)));
								case 'CreateHabit':
									return true;
								default:
									return false;
							...
							_Utils_update(
								model,
								{
									options: _Utils_update(
										options,
										{
											seenModals: _List_fromArray(
												[$author$project$Main$IntroModal])
										})
								}),
							...
							_Utils_update(
								model,
								{
									options: _Utils_update(
										...
										{
											seenModals: _List_fromArray(
												[$author$project$Main$IntroModal, $author$project$Main$FirstHabitModal, $author$project$Main$AddingHabitModal, $author$project$Main$DoHabitModal, $author$project$Main$OpenOptionsModal])
										})
								}),
							$elm$core$Platform$Cmd$none));
				default:
	...
	function (model, key) {
		return A2(
			...
			A2(
				...
				A2($elm$core$Dict$get, key, model.animations)));
	});
...
var $author$project$Page$OpenOptions = {$: 'OpenOptions'};
								...
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('add-habit'),
											$elm$html$Html$Events$onClick(
											config.pageMsg($author$project$Page$OpenOptions))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('-')
...
var $author$project$Main$viewEditingPage = F2(
	function (model, screen) {
		...
		var pageConfig = {
			...
			pageMsg: $author$project$Main$PageAction,
			showOptions: false,
			title: 'edit \"' + (title + '\"')
		};
...
var $author$project$Main$UnDoHabit = function (a) {
	return {$: 'UnDoHabit', a: a};
};
var $author$project$Main$habitViewLine = F2(
	function (model, habit) {
		var markedDone = A2($author$project$Main$shouldBeMarkedAsDone, model, habit);
		return _Utils_Tuple2(
			A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Main$OpenHabitEdit(habit.id))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('...')
			...
			A2(
				...
				_List_fromArray(
					[
						...
						markedDone ? 'habit-done' : 'habit-todo'),
						$elm$html$Html$Events$onClick(
						markedDone ? $author$project$Main$UnDoHabit(habit.id) : $author$project$Main$DoHabit(habit.id))
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Main$DoClearData = {$: 'DoClearData'};
var $author$project$Main$DoSaveOptions = {$: 'DoSaveOptions'};
var $author$project$Main$DoToggleHelp = {$: 'DoToggleHelp'};
var $author$project$Main$OpenManageHabits = {$: 'OpenManageHabits'};
var $author$project$Main$viewOptionsPage = F2(
	function (model, screen) {
		var seenAllHelp = $elm$core$List$length(model.options.seenModals) === 5;
		var pageState = {pageNumber: 0};
		var pageConfig = {
			footer: _Utils_Tuple2($author$project$Main$emptyDiv, $author$project$Main$emptyDiv),
			nLines: $author$project$Main$pageLines,
		...
		var lines = _List_fromArray(
			[
				...
				_Utils_Tuple2(
				A3($author$project$Main$periodOptionsView, false, screen.upcoming, 'upcoming-list'),
				A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
				...
				_Utils_Tuple2(
				A3($author$project$Main$periodOptionsView, false, screen.recent, 'recent-list'),
				A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('This app helps you create habits out of repeating tasks')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('It\'s like a todo list where tasks show up again after you\'ve done them')
							]))
					]));
		case 'FirstHabitModal':
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Trying adding something with the \'+\'')
							]))
					]));
		case 'AddingHabitModal':
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Give your task a name and say how long you want to wait before it repeats')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('You can make it repeat after the last time you did it or after doing another task')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('You can also set how long until it\'s first due')
							]))
					]));
		case 'DoHabitModal':
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('That\'s looking much better!')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Clicking a task marks it as done, it\'ll become due again after the period is up')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('If you need to change a task after creation you can press the \'...\' next to it for editing')
							]))
					]));
		default:
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('If you made a mistake you can click the task again to make it redue')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Your list shows tasks due and completed within 12 hours')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('You can change this in the options by clicking \'-\'')
							]))
					]));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				(!_Utils_eq(model.modal, $author$project$Main$NoModal)) ? A2(
				$elm$html$Html$div,
				A2(
					$elm$core$List$cons,
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'time', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Browser.Dom.Element":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float }, element : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"},"Habit.HabitId":{"args":[],"type":"String.String"},"Animation.Msg":{"args":[],"type":"Animation.Model.Tick"},"Main.PartialHabit":{"args":[],"type":"{ id : Maybe.Maybe Habit.HabitId, description : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"NoOps":["String.String"],"Tick":["Time.Posix"],"AnimateScreen":["Animation.Msg"],"ClearTransition":[],"DoHabit":["Habit.HabitId"],"UnDoHabit":["Habit.HabitId"],"OpenHabitEdit":["Habit.HabitId"],"DoDeleteHabit":[],"DoEditHabit":[],"OpenHabitSelect":["Main.PartialHabit","Maybe.Maybe Habit.HabitId"],"DoSelectHabit":["Maybe.Maybe Habit.HabitId"],"OpenHabitCreate":[],"DoCreateHabit":["Maybe.Maybe Habit.HabitId"],"DoSaveOptions":[],"ChangeFormField":["String.String","String.String"],"BlurFormField":["String.String"],"Cancel":[],"NewPageElement":["Result.Result Browser.Dom.Error Browser.Dom.Element"],"CloseModal":[],"ClearModal":[],"PageAction":["Page.PageMessage"],"DoClearData":[],"DoToggleHelp":[],"OpenManageHabits":[]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Page.PageMessage":{"args":[],"tags":{"ChangePage":["Basics.Int"],"OpenOptions":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Animation.Model.Tick":{"args":[],"tags":{"Tick":["Time.Posix"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));