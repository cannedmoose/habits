...
var $author$project$Main$StorageModel = F3(
	function (options, habits, version) {
		return {b: habits, d: options, b3: version};
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aJ: s.aJ + (newOffset - s.c), f: s.f, h: s.h, c: newOffset, bd: s.bd, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bd, s.aJ - (floatOffset + s.c), invalid, s.f));
		} else {
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.c, s.bd, s.aJ, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aJ: newCol, f: s.f, h: s.h, c: newOffset, bd: newRow, a: s.a});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aJ: col, f: s0.f, h: s0.h, c: offset, bd: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.c, s.bd, s.aJ, s);
	};
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aJ: 1, f: _List_Nil, h: 1, c: 0, bd: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	return _Utils_Tuple2(
		{
			...
			b: A2($author$project$HabitStore$applyDeltas, $elm$core$Dict$empty, storage2.b),
			E: 0,
			d: storage2.d,
			...
			return _Utils_update(
				model,
				{
					...
					N: $elm$core$Maybe$Just(
						{aa: 0, b: habits, d: options, e: screen, g: time})
				});
		}
	});
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($author$project$HabitStore$deltasFromDict, model.g, model.b))),
				_Utils_Tuple2(
				'version',
				$elm$json$Json$Encode$int(0))
			]));
		...
		case 0:
			return (!A2($elm$core$List$member, 2, options.j)) ? $author$project$Main$storeModel(
				_Utils_Tuple2(
					...
					cmd)) : (((!A2($elm$core$List$member, 4, options.j)) && (!$elm$core$Dict$isEmpty(model.b))) ? $author$project$Main$storeModel(
				_Utils_Tuple2(
					$author$project$Main$modalInTransition(
						_Utils_update(
							model,
...
var $author$project$Main$editHabitScreen = F2(
	function (model, habitId) {
		return A2(
			...
			A2($elm$core$Dict$get, habitId, model.b));
	});
		...
		if (_v1.$ === 1) {
			...
			return _Utils_update(
				model,
				{
					...
					e: newScreen,
					N: $elm$core$Maybe$Just(
						{aa: 1, b: habits, d: options, e: screen, g: time})
				});
		}
	});
...
var $author$project$Main$ClearModal = {$: 20};
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					habit.bD,
					$author$project$HabitStore$LastDoneChange(
						A2($author$project$Period$minusFromPosix, habit.bT, time))),
					A2(
					$author$project$HabitStore$ChangeHabit,
					habit.bD,
					$author$project$HabitStore$NextDueChange(time)),
			...
			switch (_v0.b.$) {
				...
				case 5:
					...
					var newStore = A2(
						...
						A2(
							$elm$core$Maybe$map,
							$author$project$HabitStore$applyDeltas(model.b),
							A2(
								$elm$core$Maybe$map,
								A2($author$project$HabitStore$doHabitDeltas, model.b, model.g),
								A2($elm$core$Dict$get, habitId, model.b))));
				...
				case 6:
					...
					var newStore = A2(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$map,
								A2($author$project$HabitStore$undoHabitDeltas, model.b, model.g),
								A2($elm$core$Dict$get, habitId, model.b))));
					return $author$project$Main$storeModel(
						_Utils_Tuple2(
							_Utils_update(
				...
				case 8:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							...
							model.b,
							A3($author$project$HabitStore$deleteHabitDeltas, model.b, model.g, screen.ac));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
				...
				case 9:
					if (_v0.a.$ === 1) {
						...
						var newStore = A2(
							$author$project$HabitStore$applyDeltas,
							model.b,
							A4($author$project$HabitStore$editHabitDeltas, model.b, model.g, screen.ac, screen.r));
						return $author$project$Main$storeModel(
							_Utils_Tuple2(
								A2(
								...
								case 1:
									...
									return A2(
										...
										A2(
											...
											A2($elm$core$Dict$get, screen.ac, model.b)));
								case 2:
									return true;
								default:
									return false;
...
var $author$project$Main$CloseModal = {$: 19};
...
var $author$project$Main$DoDeleteHabit = {$: 8};
var $author$project$Main$DoEditHabit = {$: 9};
...
var $author$project$Main$OpenHabitCreate = {$: 12};
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						markedDone ? $author$project$Main$UnDoHabit(habit.bD) : $author$project$Main$DoHabit(habit.bD))
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Main$DoClearData = {$: 22};
var $author$project$Main$DoSaveOptions = {$: 14};
var $author$project$Main$DoToggleHelp = {$: 23};
var $author$project$Main$OpenManageHabits = {$: 24};
